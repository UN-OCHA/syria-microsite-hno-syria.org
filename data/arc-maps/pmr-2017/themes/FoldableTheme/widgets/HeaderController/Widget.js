...
"*now":function(r){r(['dojo/i18n!*preload*themes/FoldableTheme/widgets/HeaderController/nls/Widget*["ar","bs","cs","da","de","en","el","es","et","fi","fr","he","hi","hr","id","it","ja","ko","lt","lv","nb","nl","pl","pt-br","pt-pt","ro","ru","sl","sr","sv","th","tr","zh-cn","vi","zh-hk","zh-tw","ROOT"]'])},"*noref":1}});
...
[];p.forEach(a,function(a){c.unshift(a)});a=c}b.empty(this.dynamicLinksNode);p.forEach(a,function(a){b.create("a",{href:a.url,target:"_blank",rel:"noopener noreferrer",innerHTML:k.sanitizeHTML(a.label),"class":"jimu-link jimu-align-leading jimu-leading-margin1",style:{lineHeight:this.height+"px"}},this.dynamicLinksNode)},this)},_showSwitchableElements:function(a){var c=this.switchableElements,d;for(d in c)c.hasOwnProperty(d)&&(-1<a.indexOf(d)?(b.setStyle(c[d],"display","block"),c[d].visible=!0):(b.setStyle(c[d],
"display","none"),c[d].visible=!1));this.logoClickHandle&&this.logoClickHandle.remove();0>a.indexOf("links")?this.logoClickHandle=m(this.logoNode,"click",e.hitch(this,this._onLogoClick)):this.popupLinksVisible&&this._hidePopupLink()},_switchSignin:function(){var a=g.getPortalCredential(this.appConfig.portalUrl);if(a)this.onSignIn(a);else this.onSignOut()},_onLogoClick:function(){this.popupLinkNode&&b.destroy(this.popupLinkNode);this.popupLinkNode=this._createPopupLinkNode();this.popupLinksVisible?
