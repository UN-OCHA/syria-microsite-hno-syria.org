...
require({cache:{"dojo/NodeList-fx":function(){define(["./query","./_base/lang","./aspect","./_base/fx","./fx"],function(k,e,f,d,m){k=k.NodeList;e.extend(k,{_anim:function(d,c,g){g=g||{};var h=m.combine(this.map(function(h){h={node:h};e.mixin(h,g);return d[c](h)}));return g.auto?h.play()&&this:h},wipeIn:function(d){return this._anim(m,"wipeIn",d)},wipeOut:function(d){return this._anim(m,"wipeOut",d)},slideTo:function(d){return this._anim(m,"slideTo",d)},fadeIn:function(e){return this._anim(d,"fadeIn",
e)},fadeOut:function(e){return this._anim(d,"fadeOut",e)},animateProperty:function(e){return this._anim(d,"animateProperty",e)},anim:function(e,c,g,l,k){var h=m.combine(this.map(function(f){return d.animateProperty({node:f,properties:e,duration:c||350,easing:g})}));l&&f.after(h,"onEnd",l,!0);return h.play(k||0)}});return k})},"themes/TabTheme/widgets/SidebarController/_build-generate_module":function(){define(["dojo/text!./Widget.html","dojo/text!./css/style.css","dojo/i18n!./nls/strings"],function(){})},
...
"*now":function(k){k(['dojo/i18n!*preload*themes/TabTheme/widgets/SidebarController/nls/Widget*["ar","bs","cs","da","de","en","el","es","et","fi","fr","he","hi","hr","id","it","ja","ko","lt","lv","nb","nl","pl","pt-br","pt-pt","ro","ru","sl","sr","sv","th","tr","zh-cn","vi","zh-hk","zh-tw","ROOT"]'])},"*noref":1}});
define("dojo/_base/declare dojo/_base/lang dojo/_base/array dojo/_base/html dojo/topic dojo/aspect dojo/query dojo/on dojo/mouse dojo/fx dojo/dom-geometry jimu/BaseWidget jimu/PoolControllerMixin jimu/utils dojo/NodeList-manipulate dojo/NodeList-fx".split(" "),function(k,e,f,d,m,h,c,g,l,p,r,q,t,n){return k([q,t],{baseClass:"jimu-widget-sidebar-controller jimu-main-background",moveTopOnActive:!1,maxWidth:365,minWidth:55,animTime:200,stateNode:null,currentTab:null,moreTab:!1,moreTabOpened:!1,currentOtherGroup:null,
...
"absolute";d.place(this.domNode,window.jimuConfig.layoutId);d.setStyle(this.domNode,a);this.started&&this.widgetManager.minimizeWidget(this)},createTabs:function(){var a=this.getAllConfigs(),b=[],c="";5>=a.length?(b=a,this.moreTab=!1):(b=a.splice(0,4),this.moreTab=!0);f.forEach(b,function(a){this.createTab(a);!0===a.openAtStart&&(c=a.id)},this);this.moreTab&&(this.createTab({label:this.nls.more,flag:"more",icon:this.folderUrl+"images/more_tab_icon.png",groups:a}),""===c&&f.forEach(a,function(a){!0===
...
function(e){c(e.domNode).style(n.getPositionStyle({left:0,right:0,top:0,bottom:0}));"more"===b.flag?(d=c('.more-group-pane[label\x3d"'+a.label+'"]',b.contentPane),d.append(e.domNode)):c(b.contentPane).append(e.domNode);-1===f.indexOf(b.panels,e)&&b.panels.push(e);b.panel=e}))},_getOffPanelPosition:function(a,b){var d={};a=c('div[settingid\x3d"'+a+'"]',this.stateNode)[0];a=r.position(a);d.top=a.y;window.isRTL?d.right=a.x-b.w-10:d.left=a.x+a.w+10;return d},showMoreTabContent:function(a){a=a.config.groups;
var b=null,d=null;c(this.otherGroupNode).empty();this._createOtherGroupPaneTitle();f.forEach(a,function(a){this._createMoreGroupNode(a)},this);window.isRTL?(b={left:this.getWidth()-this.minWidth,right:this.minWidth-this.getWidth()},d={left:0,right:this.minWidth}):(b={left:this.minWidth-this.getWidth(),right:this.getWidth()-this.minWidth},d={left:this.minWidth,right:0});p.combine([c(this.maxStateNode).animateProperty({properties:b,duration:this.animTime}),c(this.otherGroupNode).animateProperty({properties:d,
...
d.create("div",{"class":"other-group","data-widget-id":a.id},this.otherGroupNode),f;d.create("img",{src:a.icon,"class":"other-group-icon jimu-float-leading"},b);d.create("div",{"class":"other-group-title jimu-float-leading",innerHTML:n.stripHTML(a.label)},b);f=d.create("img",{"class":"other-group-choose jimu-float-trailing",style:{opacity:0},src:this.folderUrl+(window.isRTL?"images/arrow_choose_rtl.png":"images/arrow_choose.png")},b);this.own(g(b,"click",e.hitch(this,this._onOtherGroupClick,a)));
this.own(g(b,"mousedown",e.hitch(this,function(){c(b).addClass("jimu-state-active")})));this.own(g(b,"mouseup",e.hitch(this,function(){c(b).removeClass("jimu-state-active")})));this.own(g(b,l.enter,e.hitch(this,function(){c(f).style({opacity:1})})));this.own(g(b,l.leave,e.hitch(this,function(){c(f).style({opacity:0})})));return b},_hideOtherGroupPane:function(){var a=null,a=window.isRTL?{left:0-this.getWidth(),right:this.getWidth()}:{left:this.getWidth(),right:0-this.getWidth()};p.combine([c(this.maxStateNode).animateProperty({properties:{left:0,
...
return null},_createTitleNode:function(a){var b=(this.getWidth()-2-21-72)/5,c=a.label,f=a.icon,b=d.create("div",{title:c,"class":"title-node jimu-float-leading jimu-leading-margin15",settingid:a.id,i:this.tabs.length,style:{width:b+"px"}},this.titleListNode);d.create("div",{"class":"tab-indicator"},b);d.create("img",{src:f},b);a=d.create("div",{title:c,"class":"title-node",settingid:a.id,i:this.tabs.length},this.minStateNode);d.create("div",{"class":"tab-indicator"},a);d.create("img",{src:f},a);this.own(g(b,
"click",e.hitch(this,this.onSelect)));this.own(g(b,l.enter,e.hitch(this,this._onMouseEnter)));this.own(g(b,l.leave,e.hitch(this,this._onMouseLeave)));this.own(g(a,"click",e.hitch(this,this._onMinIconClick,a)));this.own(g(a,l.enter,e.hitch(this,this._onMouseEnter)));this.own(g(a,l.leave,e.hitch(this,this._onMouseLeave)));return b},_onMinIconClick:function(a){a=c(a).attr("i")[0];var b=this.tabs[a],d=b.config;!1===d.inPanel?b.selected?(b.selected=!1,this.widgetManager.closeWidget(d.id)):(this._hideOffPanelWidgets(),
this.selectTab(parseInt(a,10))):(this._hideOffPanelWidgets(),this.widgetManager.maximizeWidget(this),this.selectTab(parseInt(a,10)))},_hideOffPanelWidgets:function(){f.forEach(this.tabs,function(a){"more"!==a.flag?a.config.inPanel||(a.selected=!1,this.widgetManager.closeWidget(a.config.id)):f.forEach(a.config.groups,function(b){b.inPanel||(a.selected=!1,this.widgetManager.closeWidget(b.id))},this)},this)},_createContentNode:function(a){var b=d.create("div",{"class":"content-node"},this.contentListNode);
