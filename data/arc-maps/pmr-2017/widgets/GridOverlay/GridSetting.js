...
define("dojo/_base/declare dojo/dom-class dojo/json dojo/_base/array dojo/_base/lang dojo/_base/Color dijit/_WidgetBase dijit/_TemplatedMixin dijit/_WidgetsInTemplateMixin dijit/registry ./lib/GridOverlay jimu/dijit/Message dojo/i18n!./setting/nls/strings dojo/text!./GridSetting.html dijit/form/HorizontalSlider dijit/form/NumberSpinner jimu/dijit/ColorPicker jimu/dijit/CheckBox".split(" "),function(m,d,l,n,k,h,p,q,r,t,u,v,w,x){var e=function(b,c){c instanceof h||(c=new h(c));var a=c.toHex();c=128<
.2126*c.r+.7152*c.g+.0722*c.b?new h([0,0,0]):new h([255,255,255]);b.innerHTML="\x3cdiv class\x3d'grid-overlay-setting-color-picker-text' style\x3d'"+("color:"+c+";")+"'\x3e"+a+"\x3c/div\x3e"},f=function(b,c,a,d){isNaN(d)?(b.value=5,b.setDisplayedValue(5)):4<d&&73>d&&c.setFontSize(a,d)},g=function(b,c,a,d){isNaN(d)?(b.value=1,b.setDisplayedValue(1)):0<d&&11>d&&c.setLineWidth(a,d)};return m([p,q,r],{templateString:x,baseClass:"grid-overlay-setting",verticalLabelsClicked:!1,horizontalLabelsClicked:!1,
map:null,config:null,nls:null,gridOverlayCtrl:null,constructor:function(b){this.map=b.map;this.config=b.config;this.nls=w},postCreate:function(){this.setConfig(this.config);var b=this,c=new u(k.mixin({map:this.map,enabled:!0},this.config));this.gridOverlayCtrl=c;this.minIntervalSpacing.onChange=k.hitch(this,function(a){this.minIntervalSpacingVal.innerHTML=a+"px";c.setMinIntervalSpacing(a)});this.lineOpacity.onChange=k.hitch(this,function(a){this.lineOpacityVal.innerHTML=Math.round(100*a)+"%";c.setLineOpacity(a)});
this.labelOpacity.onChange=k.hitch(this,function(a){this.labelOpacityVal.innerHTML=Math.round(100*a)+"%";c.setLabelOpacity(a)});this.colorPicker0.onChange=function(a){e(this.domNode,a);c.setColor(0,a.toHex())};this.colorPicker1.onChange=function(a){e(this.domNode,a);c.setColor(1,a.toHex())};this.colorPicker2.onChange=function(a){e(this.domNode,a);c.setColor(2,a.toHex())};this.colorPicker3.onChange=function(a){e(this.domNode,a);c.setColor(3,a.toHex())};this.colorPicker4.onChange=function(a){e(this.domNode,
a);c.setColor(4,a.toHex())};this.colorPicker5.onChange=function(a){e(this.domNode,a);c.setColor(5,a.toHex())};this.fontSize0.onChange=function(a){f(this,c,0,a)};this.fontSize1.onChange=function(a){f(this,c,1,a)};this.fontSize2.onChange=function(a){f(this,c,2,a)};this.fontSize3.onChange=function(a){f(this,c,3,a)};this.fontSize4.onChange=function(a){f(this,c,4,a)};this.fontSize5.onChange=function(a){f(this,c,5,a)};this.lineSize0.onChange=function(a){g(this,c,0,a)};this.lineSize1.onChange=function(a){g(this,
c,1,a)};this.lineSize2.onChange=function(a){g(this,c,2,a)};this.lineSize3.onChange=function(a){g(this,c,3,a)};this.lineSize4.onChange=function(a){g(this,c,4,a)};this.lineSize5.onChange=function(a){g(this,c,5,a)};this.verticalLabels.onclick=function(){b.verticalLabelsClicked=!0;b.horizontalLabelsClicked=!1;b._toggleHorzVertOptions(!1);c.setVerticalLabels(b.verticalLabelsClicked)};this.horizontalLabels.onclick=function(){b.verticalLabelsClicked=!1;b.horizontalLabelsClicked=!0;b._toggleHorzVertOptions(!0);
c.setVerticalLabels(!b.horizontalLabelsClicked)}},startup:function(){this.inherited(arguments)},setConfig:function(b){this.config=void 0!==b?b:this._setConfig();this.minIntervalSpacing.set("value",this.config.minIntervalSpacing);this.minIntervalSpacingVal.innerHTML=this.config.minIntervalSpacing+"px";this.lineOpacity.set("value",this.config.lineOpacity);this.lineOpacityVal.innerHTML=Math.round(100*this.config.lineOpacity)+"%";this.labelOpacity.set("value",this.config.labelOpacity);this.labelOpacityVal.innerHTML=
Math.round(100*this.config.labelOpacity)+"%";for(b=0;6>b;b++)this["colorPicker"+b].setColor(new h(this.config.colors[b])),this["colorPicker"+b].picker.setColor(this.config.colors[b]),e(this["colorPicker"+b].domNode,this.config.colors[b]);this.fontSize0.setValue(this.config.fontSizes[0]);this.fontSize1.setValue(this.config.fontSizes[1]);this.fontSize2.setValue(this.config.fontSizes[2]);this.fontSize3.setValue(this.config.fontSizes[3]);this.fontSize4.setValue(this.config.fontSizes[4]);this.fontSize5.setValue(this.config.fontSizes[5]);
this.lineSize0.setValue(this.config.lineWidths[0]);this.lineSize1.setValue(this.config.lineWidths[1]);this.lineSize2.setValue(this.config.lineWidths[2]);this.lineSize3.setValue(this.config.lineWidths[3]);this.lineSize4.setValue(this.config.lineWidths[4]);this.lineSize5.setValue(this.config.lineWidths[5]);this._toggleHorzVertOptions(!this.config.verticalLabels);this.config.enableGridOnClose?this.cbxShowGrid.check():this.cbxShowGrid.uncheck()},getConfig:function(){if(this._checkValidValues())return new v({message:this.nls.errorMessage}),
!1;this.config=this.gridOverlayCtrl.getSettings();this.config.enableGridOnClose=this.cbxShowGrid.getValue();return this.config},showCheckbox:function(b){this.trShowGrid.style.display=b?"block":"none"},_saveConfig:function(){window.localStorage.setItem("storedGridSettings",l.stringify(this.getConfig()))},_setConfig:function(){var b=l.parse(window.localStorage.getItem("storedGridSettings"));return null!==b?b:this.config},_checkValidValues:function(){return n.some([this.fontSize0,this.fontSize1,this.fontSize2,
this.fontSize3,this.fontSize4,this.fontSize5,this.lineSize0,this.lineSize1,this.lineSize2,this.lineSize3,this.lineSize4,this.lineSize5],function(b){if((b=t.byId(b))&&(b.value<b.constraints.min||b.value>b.constraints.max))return!0},this)},_toggleHorzVertOptions:function(b){b?(d.remove(this.horizontalLabels,"image-labels horizontalLabel"),d.add(this.horizontalLabels,"image-labels horizontalLabelClicked"),d.remove(this.verticalLabels,"image-labels verticalLabelClicked"),d.add(this.verticalLabels,"image-labels verticalLabel")):
