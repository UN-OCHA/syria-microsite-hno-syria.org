...
this.pages.length&&(l(".point",this.domNode).removeClass("point-selected"),e.addClass(this.pages[a].pointNode,"point-selected"));this.viewStack.switchView(this.pages[a].pageNode)},createPageItems:function(a,c,b){var d,g,e;d=this.nodes.length;g=b.rows*b.cols;b=(a+1)*g;e=b-d;b=Math.min(b,d);for(a*=g;a<b;a++)this.createItemNode(a,c);for(a=d;a<d+e;a++)this.createEmptyItemNode(c)},createItemNode:function(a,c){var b;c=f.create("div",{"class":"icon-node jimu-float-leading"},c);b=(this.nodeWidth-this.nodes[a].size)/
2;q.set(this.nodes[a].domNode,{position:"absolute",left:b+"px",top:b+"px","margin-left":""});this.nodes[a].placeAt(c)},createEmptyItemNode:function(a){return f.create("div",{"class":"icon-node jimu-float-leading"},a)},createCloseBtn:function(){var a;a=f.create("div",{"class":"close"},this.domNode);f.create("div",{"class":"close-inner"},a);m(a,"click",k.hitch(this,function(){this.hide()}));return a},hide:function(){e.setStyle(this.domNode,"display","none");this.forIcon&&this.forIcon.setOpened(!1)},
