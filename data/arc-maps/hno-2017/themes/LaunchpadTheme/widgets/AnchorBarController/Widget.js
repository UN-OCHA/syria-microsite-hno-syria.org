...
require({cache:{"themes/LaunchpadTheme/widgets/AnchorBarController/DockableItem":function(){define("dojo/_base/declare dojo/_base/lang dojo/dom-class dojo/dom-attr dojo/_base/fx ./BaseIconItem".split(" "),function(p,k,c,e,g,f){return p([f],{visible:!0,postCreate:function(){this.inherited(arguments);c.add(this.iconItemNode,"dockable");e.set(this.domNode,"settingid",this.config.id)},hideAnim:function(){var f=this.domNode.style,e=[],l={};window.isRTL?l["margin-right"]=0:l["margin-left"]=0;c.remove(this.iconItemStatus,
"selected");e.push(g.animateProperty({node:this.domNode,duration:500,properties:l,onEnd:k.hitch(this,function(){f.display="none";this.visible=!1})}));e.push(g.animateProperty({node:this.iconItemNode,duration:500,properties:{width:1}}));e.push(g.animateProperty({node:this.imgNode,duration:500,properties:{width:1}}));return e},showAnim:function(e){var f=this.domNode.style,l=this.iconItemNode.style,n=this.imgNode.style,m=[],p=this.size,a={};e={start:function(){f.display="";return 0},end:e};window.isRTL?
a["margin-right"]=e:a["margin-left"]=e;m.push(g.animateProperty({node:this.domNode,duration:500,properties:a,onEnd:k.hitch(this,function(){this.isOpen&&c.add(this.iconItemStatus,"selected");this.visible=!0})}));m.push(g.animateProperty({node:this.iconItemNode,duration:500,properties:{width:{start:function(){l.width="1px";return 1},end:p}}}));m.push(g.animateProperty({node:this.imgNode,duration:500,properties:{width:{start:function(){n.width="1px";return 1},end:20}}}));return m}})})},"themes/LaunchpadTheme/widgets/AnchorBarController/BaseIconItem":function(){define("dojo/_base/declare dojo/_base/lang dojo/dom-class dojo/dom-style dojo/on dojo/mouse dojo/Evented dijit/_WidgetBase dijit/_TemplatedMixin dijit/popup dijit/TooltipDialog dojo/text!./BaseIconItem.html".split(" "),
function(p,k,c,e,g,f,n,q,l,r,m,t){return p([q,l,n],{baseClass:"jimu-anchorbar-iconitem jimu-float-leading",templateString:t,config:null,backgroundIndex:-1,isOpen:!1,panelIndex:-1,size:40,postCreate:function(){this.inherited(arguments);this.tooltipDialog=new m({content:this.config.label,"class":"launchpad-tooltip"});c.add(this.iconItemNode,"icon-item-background"+this.getBackgroundColorIndex());this.own(g(this.iconItemNode,f.enter,k.hitch(this,function(){window.appInfo.isRunInMobile||r.open({parent:this,
popup:this.tooltipDialog,around:this.iconItemNode,orient:["above-centered"],onCancel:k.hitch(this,function(){r.close(this.tooltipDialog)})})})));this.own(g(this.iconItemNode,f.leave,k.hitch(this,function(){window.appInfo.isRunInMobile||r.close(this.tooltipDialog)})))},getConfigForPanel:function(){var a=k.clone(this.config);a.backgroundColor=this.getColor();a.panel.position=this._initPosition();a.panel.position.index=this.panelIndex;return a},_initPosition:function(){return{top:window.appInfo.isRunInMobile?
...
"selected"),this.iconItemNode&&c.add(this.iconItemNode,"selected"),this.isOpen=!0):(this.iconItemStatus&&c.remove(this.iconItemStatus,"selected"),this.iconItemNode&&c.remove(this.iconItemNode,"selected"),this.isOpen=!1,this.panelIndex=-1)},getPanelIndex:function(){return this.panelIndex},setPanelIndex:function(a){this.panelIndex=a},getColor:function(){return e.get(this.iconItemNode,"background-color")||"#FFFFFF"},getBackgroundColorIndex:function(){return this.backgroundIndex%6}})})},"themes/LaunchpadTheme/widgets/AnchorBarController/GroupItems":function(){define("dojo/_base/declare dojo/_base/array dojo/_base/lang dojo/fx dojo/on dojo/Evented dojo/dom-style dojo/dom-class dojo/dom-geometry dojo/dnd/move dijit/_WidgetBase dijit/_TemplatedMixin dojo/text!./GroupItems.html ./BaseIconItem".split(" "),
function(p,k,c,e,g,f,n,q,l,r,m,t,a,h){return p([m,t,f],{baseClass:"jimu-anchorbar-controller-group",templateString:a,config:null,dockableItem:null,backgroundColor:null,itemList:[],box:null,postCreate:function(){this.inherited(arguments);k.forEach(this.config.widgets,function(a,u){a=new h({config:a,backgroundIndex:u});a.placeAt(this.containerNode);this.own(g(a,"nodeClick",c.hitch(this,this._onIconClick)));this.itemList.push(a)},this);q.add(this.colorfulHeader,"icon-item-background"+this.dockableItem.getBackgroundColorIndex())},
startup:function(){this.inherited(arguments);this.box=l.getMarginBox(this.domNode);this.makeMoveable(this.titleNode,this.box)},getItemList:function(){return this.itemList},makeMoveable:function(a,h){var b;this.disableMoveable();b=l.getMarginBox(jimuConfig.layoutId);b.l-=.5*h.w;b.w+=h.w;this.moveable=new r.boxConstrainedMoveable(this.domNode,{box:b,handle:a||this.titleNode,within:!0});this.own(g(this.moveable,"Moving",c.hitch(this,this.onMoving)));this.own(g(this.moveable,"MoveStop",c.hitch(this,this.onMoveStop)))},
getItemNum:function(){return this.config.widgets.length},disableMoveable:function(){this.moveable&&(this.moveable.destroy(),this.moveable=null)},onMoving:function(a){n.set(a.node,"opacity",.9)},onMoveStop:function(a){n.set(a.node,"opacity",1)},open:function(){e.wipeIn({node:this.domNode,duration:400}).play()},close:function(){e.wipeOut({node:this.domNode,duration:400}).play();this.dockableItem.setOpened(!1)},closeImmedaite:function(){n.set(this.domNode,"display","none");this.dockableItem.setOpened(!1)},
...
function(p,k,c,e,g,f,n,q,l,r,m,t){return p([l,r],{baseClass:"jimu-anchorbar-more-pupup jimu-main-background",templateString:'\x3cdiv\x3e\x3cdiv class\x3d"pages" data-dojo-attach-point\x3d"pagesNode"\x3e\x3c/div\x3e\x3cdiv class\x3d"points jimu-corner-bottom"\x3e\x3cdiv class\x3d"points-inner"data-dojo-attach-point\x3d"pointsNode"\x3e\x3c/div\x3e\x3c/div\x3e\x3c/div\x3e',margin:4,nodes:[],forIcon:null,postCreate:function(){this.pages=[];this.createCloseBtn()},startup:function(){this.viewStack=new m({views:[],
viewType:"dom"},this.pagesNode);this.viewStack.startup()},setForIcon:function(a){this.forIcon=a},setNodes:function(a){var h=!1,h=this.nodes.length!==a.length?!1:c.every(this.nodes,function(h){return c.some(a,function(a){return h.id===a.id})});h||(this.nodes=a,this.oldGridParam=null,this.resize())},resize:function(){var a=this._calculateGridParam(),h;null!==a?(e.setStyle(this.domNode,t.getPositionStyle(a.position)),this.nodeWidth=a.cellSize-this.margin,this.oldGridParam&&this.oldGridParam.rows===a.rows&&
this.oldGridParam.cols===a.cols||(this.clearPages(),this.createPages(a)),c.forEach(q(".icon-node",this.domNode),k.hitch(this,function(h,c){this.setItemNodePosition(h,c,a)})),this.oldGridParam=a,h=q("div.close",this.domNode)[0],e.setStyle(h,{width:.25*this.nodeWidth+"px",height:.25*this.nodeWidth+"px"})):(this.oldGridParam=null,e.setStyle(this.domNode,t.getPositionStyle({left:0,top:0,width:0,height:0,zIndex:111})),this.nodeWidth=0)},setItemNodePosition:function(a,h,c){var g;g=0===h%c.cols?0:this.margin/
2;h=h%(c.rows*c.cols)<c.cols?0:this.margin/2;c={};"number"===typeof this.nodeWidth&&(c.width=this.nodeWidth+"px",c.height=this.nodeWidth+"px");"number"===typeof g&&(window.isRTL?c.marginRight=g+"px":c.marginLeft=g+"px");"number"===typeof h&&(c.marginTop=h+"px");e.setStyle(a,c)},clearPages:function(){c.forEach(this.pages,function(a){this.viewStack.removeView(a.pageNode)},this);f.empty(this.pointsNode);this.pages=[]},createPages:function(a){var c,e,u,b;c=Math.ceil(this.nodes.length/(a.rows*a.cols));
for(e=0;e<c;e++)u=f.create("div",{"class":"page"}),this.createPageItems(e,u,a),this.viewStack.addView(u),1<c&&(b=f.create("div",{"class":"point"},this.pointsNode),this.own(g(b,"click",k.hitch(this,this._onPageNodeClick,e)))),this.pages.push({pageNode:u,pointNode:b});0<this.viewStack.views.length&&this._selectPage(0)},_onPageNodeClick:function(a){this._selectPage(a)},_selectPage:function(a){1<this.pages.length&&(q(".point",this.domNode).removeClass("point-selected"),e.addClass(this.pages[a].pointNode,
"point-selected"));this.viewStack.switchView(this.pages[a].pageNode)},createPageItems:function(a,c,e){var h,b,d;h=this.nodes.length;b=e.rows*e.cols;e=(a+1)*b;d=e-h;e=Math.min(e,h);for(a*=b;a<e;a++)this.createItemNode(a,c);for(a=h;a<h+d;a++)this.createEmptyItemNode(c)},createItemNode:function(a,c){var e;c=f.create("div",{"class":"icon-node jimu-float-leading"},c);e=(this.nodeWidth-this.nodes[a].size)/2;n.set(this.nodes[a].domNode,{position:"absolute",left:e+"px",top:e+"px","margin-left":""});this.nodes[a].placeAt(c)},
createEmptyItemNode:function(a){return f.create("div",{"class":"icon-node jimu-float-leading"},a)},createCloseBtn:function(){var a;a=f.create("div",{"class":"close"},this.domNode);f.create("div",{"class":"close-inner"},a);g(a,"click",k.hitch(this,function(){this.hide()}));return a},hide:function(){e.setStyle(this.domNode,"display","none");this.forIcon&&this.forIcon.setOpened(!1)},show:function(){e.setStyle(this.domNode,"display","block")},_calculateGridParam:function(){var a,c,g,f,b=!1,d=!0;a=e.getContentBox(jimuConfig.mapId);
c=Math.min(a.w,a.h)-40;if(240<=c)f=80;else{f=Math.floor(c/3);if(10>f)return null;b=!0;60>f&&(d=!1)}c=Math.floor((a.h-40)/f);g=Math.floor((a.w-40)/f);c=4<c?4:c;c=3>c?3:c;g=3>c?3:4<g?4:g;return{rows:c,cols:g,cellSize:f,iconScaled:b,showLabel:d,position:{top:(a.h-f*c)/2,bottom:(a.h-f*c)/2,left:(a.w-f*g)/2,right:(a.w-f*g)/2,width:f*g-this.margin*(g-1)/2,height:f*c-this.margin*(c-1)/2,zIndex:111}}}})})},"themes/LaunchpadTheme/widgets/AnchorBarController/_build-generate_module":function(){define(["dojo/text!./Widget.html",
"dojo/text!./css/style.css","dojo/i18n!./nls/strings"],function(){})},"url:themes/LaunchpadTheme/widgets/AnchorBarController/BaseIconItem.html":'\x3cdiv\x3e\r\n  \x3cdiv class\x3d"icon-item" data-dojo-attach-point\x3d"iconItemNode"\r\n       data-dojo-attach-event\x3d"onclick:_onNodeClick"\x3e\r\n    \x3cimg class\x3d"icon" src\x3d"${config.icon}" data-dojo-attach-point\x3d"imgNode"/\x3e\r\n  \x3c/div\x3e\r\n  \x3cdiv class\x3d"status" data-dojo-attach-point\x3d"iconItemStatus"\x3e\r\n  \x3c/div\x3e\r\n\x3c/div\x3e\r\n',
...
define("dojo/_base/declare dojo/_base/lang dojo/_base/array dojo/dom-geometry dojo/dom-style dojo/dom-class dojo/dom-construct dojo/fx dojo/on dojo/query dojo/aspect jimu/BaseWidget jimu/PoolControllerMixin ./DockableItem ./GroupItems ./PopupMoreNodes".split(" "),function(p,k,c,e,g,f,n,q,l,r,m,t,a,h,v,u){return p([t,a],{baseClass:"jimu-anchorbar-controller",visibleIcons:0,iconList:[],enableNext:!1,enablePrevious:!1,currentMode:1,iconMargin:8,groupList:[],openedIds:[],currentStyle:"default",postCreate:function(){this.inherited(arguments);
this.iconList=[];this.groupList=[];this.openedIds=[];this.currentStyle=this.appConfig.theme.styles[0];this.allConfigs=this.getAllConfigs();c.forEach(this.allConfigs,function(b,d){this._createItem(b,d)},this)},_createItem:function(b,d){var a;d=new h({config:b,backgroundIndex:d});d.placeAt(this.iconGroupNode);this.iconList.push(d);d.isGroup()?(a=new v({config:b,dockableItem:d}),b=window.appInfo.isRunInMobile?jimuConfig.layoutId:jimuConfig.mapId,a.placeAt(b),g.set(a.domNode,"display","none"),this.own(l(a,
"groupItemClicked",k.hitch(this,function(b){this._onDockableNodeClick(b.target)}))),this.own(l(d,"nodeClick",k.hitch(this,function(b){this._onGroupNodeClick(b.target,a)}))),this.groupList.push(a)):this.own(l(d,"nodeClick",k.hitch(this,function(b){this._onDockableNodeClick(b.target)})));return d},startup:function(){this.inherited(arguments);this.resize();c.some(this.iconList,function(b,d){if(b.isOpenAtStart())return window.appInfo.isRunInMobile||this._makeIconVisible(d),b._onNodeClick(),!0},this)},
...
function(b){d=this._getIconItemById(b);null!==d&&d._onNodeClick()},this)},getOpenedIds:function(){this.inherited(arguments);return c.filter(this.openedIds,function(b){return"undefined"!==typeof b})},_highLight:function(b){this.hlDiv&&this._removeHighLight();if(b&&"none"!==g.get(b,"display")){var d=g.get(b,"margin-left"),a=e.getMarginBox(b),d={position:"absolute",left:a.l+d+"px",top:a.t+"px",width:"40px",height:"40px"};"style2"!==this.currentStyle&&(d["margin-top"]="-20px");this.hlDiv=n.create("div",
{style:d,"class":"icon-highlight"},b,"before")}},_removeHighLight:function(){this.hlDiv&&(n.destroy(this.hlDiv),this.hlDiv=null)},clearIconGroupNode:function(){for(;this.iconGroupNode.firstChild;)this.iconGroupNode.removeChild(this.iconGroupNode.firstChild)},resize:function(){window.appInfo.isRunInMobile?(1===this.currentMode&&(this.currentMode=2,f.add(this.domNode,"mobile"),this.clearIconGroupNode(),this.lastVisibleIcons=0),this.popupMore&&this.popupMore.hide(),this.switchToMobileStyle()):(2===this.currentMode&&
(this.currentMode=1,f.remove(this.domNode,"mobile"),this.clearIconGroupNode(),this.lastVisibleIcons=0,g.set(this.iconGroupNode,"width",80*this.allConfigs.length+"px"),c.forEach(this.iconList,function(b){b.placeAt(this.iconGroupNode)},this)),this.switchToNormalStyle());this._resizeOpenedPanel()},switchToMobileStyle:function(){var b;b=e.getContentBox(jimuConfig.mapId).w;g.set(this.iconGroupNode,"width",Math.max(b,80*this.allConfigs.length)+"px");this.visibleIcons=Math.floor(b/48);this.visibleIcons>=
this.iconList.length&&(this.visibleIcons=this.iconList.length);this.visibleIcons!==this.lastVisibleIcons?(this.lastVisibleIcons=this.visibleIcons,this.clearIconGroupNode(),this._reArrangeIconItems(b)):this._adjustIconMargin(b)},_reArrangeIconItems:function(b){var d,a,e=[],f;a=(d=this.visibleIcons<this.iconList.length)?this.visibleIcons-1:this.visibleIcons;this.iconMargin=Math.floor((b-40*this.visibleIcons)/(this.visibleIcons+1));c.forEach(this.iconList,function(b,d){f={display:"",position:"",left:"",
top:""};g.set(b.iconItemNode,{width:"40px",height:"40px"});g.set(b.imgNode,{width:"20px",height:"20px"});d<a?(window.isRTL?f["margin-right"]=this.iconMargin+"px":f["margin-left"]=this.iconMargin+"px",g.set(b.domNode,f),b.placeAt(this.iconGroupNode)):(g.set(b.domNode,f),e.push(b))},this);d&&(b=this._createIconItemForMore(),f={},window.isRTL?f["margin-right"]=this.iconMargin+"px":f["margin-left"]=this.iconMargin+"px",g.set(b.domNode,f),b.placeAt(this.iconGroupNode),this.own(l(b,"nodeClick",k.hitch(this,
function(b){this._onShowMoreNodeClick(b.target,e)}))))},_createIconItemForMore:function(){return new h({config:{id:"show_more_widget_icons",label:this.nls.more,icon:this.folderUrl+"images/more_icon.png"},backgroundIndex:this.visibleIcons})},_adjustIconMargin:function(b){var d={};this.iconMargin=Math.floor((b-40*this.visibleIcons)/(this.visibleIcons+1));window.isRTL?d["margin-right"]=this.iconMargin+"px":d["margin-left"]=this.iconMargin+"px";r("div.jimu-anchorbar-iconitem",this.iconGroupNode).forEach(function(b){g.set(b,
d)},this)},switchToNormalStyle:function(){var b,d,a=0;b=e.getContentBox(jimuConfig.mapId);d=Math.floor(b.w/2);d>48*this.allConfigs.length+60&&(d=48*this.allConfigs.length+60);g.set(this.domNode,{width:d+"px",left:Math.floor((b.w-d)/2)+"px"});b=d-60;this.visibleIcons=Math.floor(b/48);this.visibleIcons>this.iconList.length&&(this.visibleIcons=this.iconList.length);c.some(this.iconList,function(b,d){if(b.visible)return a=d,!0});d=a+this.visibleIcons-1;d>=this.iconList.length&&(d=this.iconList.length-
1,a=d-this.visibleIcons+1);this.iconMargin=Math.floor((b-40*this.visibleIcons)/(this.visibleIcons+1));this._adjustIconStyle(a,d)},_previous:function(){var b=-1,a=-1,e=[];this.enablePrevious&&(c.some(this.iconList,function(a,d){if(a.visible)return b=d-1,!0},this),0<=b&&(a=b+this.visibleIcons,e=e.concat(this.iconList[a].hideAnim(this.iconMargin),this.iconList[b].showAnim(this.iconMargin)),q.combine(e).play(),this.enableNext=!0,f.add(this.nextButton,"enabled"),0===b&&(this.enablePrevious=!1,f.remove(this.previousButton,
"enabled"))))},_next:function(){var b=-1,a=-1,e=[];this.enableNext&&(c.some(this.iconList,function(a,d){if(a.visible)return b=d,!0},this),0<=b&&(a=b+this.visibleIcons,e=e.concat(this.iconList[b].hideAnim(this.iconMargin),this.iconList[a].showAnim(this.iconMargin)),q.combine(e).play(),this.enablePrevious=!0,f.add(this.previousButton,"enabled"),a===this.iconList.length-1&&(this.enableNext=!1,f.remove(this.nextButton,"enabled"))))},_getGroupPanelPosition:function(b,a){var d={};b=e.position(b.iconItemNode);
var c=e.getContentBox(jimuConfig.mapId);d.top=b.y-a.h-8;d.left=window.isRTL?b.x<a.w+8?8:b.x-a.w+b.w:b.x+a.w+8>c.w?c.w-a.w-8:b.x;return d},_getOffPanelPosition:function(b,a){var d={},c=e.position(b.iconItemNode),f=e.getContentBox(jimuConfig.mapId);d.bottom=f.h-(c.y+8)+20;window.isRTL?d.right=c.x<a.w+8?f.w-a.w-8:c.x-a.w:d.left=c.x+a.w+8>f.w?f.w-a.w-8:c.x;b.config.position&&(d.relativeTo=b.config.position.relativeTo);return d},_createPopupMoreNodes:function(){this.popupMore||(this._createCoverNode(),
this.popupMore=new u,this.popupMore.placeAt(jimuConfig.mapId),m.after(this.popupMore,"show",k.hitch(this,function(){g.set(this.moreIconPaneCoverNode,"display","")}),!0),m.after(this.popupMore,"hide",k.hitch(this,function(){g.set(this.moreIconPaneCoverNode,"display","none")}),!0))},_onShowMoreNodeClick:function(b,a){this._createPopupMoreNodes();b.isOpen?(this.popupMore.setForIcon(b),this.popupMore.setNodes(a),this.popupMore.show()):this.popupMore.hide()},_getIconItemById:function(b){var a=null;c.some(this.iconList,
...
(a.close(),this._removeFromOpenedIds(b.config.id))},_onDockableNodeClick:function(b){var a,c;!1===b.config.inPanel?b.isOpen?this.widgetManager.loadWidget(b.config).then(k.hitch(this,function(a){this._addToOpenedIds(b.config.id);var d=this._getOffPanelPosition(b,this.widgetManager.getWidgetMarginBox(a));d.zIndex=100;a.setPosition(d,this.containerNode);this.widgetManager.openWidget(a);this.own(m.after(a,"onClose",k.hitch(this,function(){b.setOpened(!1);this._removeFromOpenedIds(b.config.id)})))})):
(this.widgetManager.closeWidget(b.config.id),this._removeFromOpenedIds(b.config.id)):(a=b.config.id+"_panel",b.isOpen?(b.setPanelIndex(this._calPanelIndex()),c=b.getConfigForPanel(),this.panelManager.showPanel(c).then(k.hitch(this,function(a){a.setPosition(c.panel.position);m.after(a,"onClose",k.hitch(this,function(){b.setOpened(!1);this._removeFromOpenedIds(b.config.id)}))})),this.popupMore&&this.popupMore.hide(),this._addToOpenedIds(b.config.id)):(this.panelManager.closePanel(a),this._removeFromOpenedIds(b.config.id)))},
_calPanelIndex:function(){var b=[],a,e;c.forEach(this.iconList,function(a){!a.isGroup()&&!1!==a.config.inPanel&&a.isOpen&&b.push(a.getPanelIndex())});c.forEach(this.groupList,function(a){c.forEach(a.getItemList(),function(a){!1!==a.config.inPanel&&a.isOpen&&b.push(a.getPanelIndex())})});if(0===b.length)return 0;b.sort(function(a,b){return a-b});if(0<b[0])return 0;a=0;for(e=b.length-1;a<e;a++)if(1<b[a+1]-b[a])return b[a]+1;return b[e]+1},_createCoverNode:function(){this.moreIconPaneCoverNode=n.create("div",
{"class":"jimu-more-icon-cover"},jimuConfig.layoutId)},_resizeOpenedPanel:function(){var a;c.forEach(this.iconList,function(b){if(!b.isGroup()&&!1!==b.config.inPanel&&b.isOpen&&(a=this.panelManager.getPanelById(b.config.id+"_panel")))a.onWindowResize()},this);c.forEach(this.groupList,function(b){c.forEach(b.getItemList(),function(b){if(!1!==b.config.inPanel&&b.isOpen&&(a=this.panelManager.getPanelById(b.config.id+"_panel")))a.onWindowResize()},this)},this)},_makeIconVisible:function(a){var b;this.visibleIcons!==
this.iconList.length&&(a-=Math.floor(this.visibleIcons/2),a=0<=a?a:0,b=a+this.visibleIcons-1,b>=this.iconList.length&&(b=this.iconList.length-1,a=b-this.visibleIcons+1),this._adjustIconStyle(a,b))},_adjustIconStyle:function(a,d){var b;c.forEach(this.iconList,function(c,e){c.visible=e>=a&&e<=d;b={position:"",left:"",top:"",display:c.visible?"":"none"};window.isRTL?b["margin-right"]=this.iconMargin+"px":b["margin-left"]=this.iconMargin+"px";g.set(c.domNode,b);g.set(c.iconItemNode,{width:"40px",height:"40px"});
g.set(c.imgNode,{width:"20px",height:"20px"})},this);d<this.allConfigs.length-1?(f.add(this.nextButton,"enabled"),this.enableNext=!0):(f.remove(this.nextButton,"enabled"),this.enableNext=!1);0<a?(this.enablePrevious=!0,f.add(this.previousButton,"enabled")):(this.enablePrevious=!1,f.remove(this.previousButton,"enabled"))}})});;;;;
