...
"Rate limit exceeded. Please try again later."===a.message?this._resetRouteSearch(b,this.nls.networkServiceChooser.rateLimitExceeded):a&&"Error invoking service"===a.message?this._resetRouteSearch(b,this.nls.networkServiceChooser.errorInvokingService):this._resetRouteSearch(b,this.nls.networkServiceChooser.invalidRouteServiceURL);this.loading.hide()}))},_getValidRouteURL:function(){var a,c,d,e;this.routeChooser&&this.agolFlag?(a=this.routeChooser.getSelectedItem(),c=a.url):c=this.serviceURL.value;
d=c.lastIndexOf("/");e=c.substr(0,d+1);a=this._urlValidator(e);this.routeName="";a&&(this.routeName=c.substring(d+1,c.length+1),c=e);return c},_createTree:function(b,c,e){var g=this,h,f;k.empty(e);h={data:[{id:1,name:"Route Layers",url:b,root:!0}],getChildren:function(a){return this.query({parent:a.id})}};if(this.routeName)for(f=0;f<c.length;f++)this.routeName===c[f]&&h.data.push({id:c[f],name:c[f],url:b+c[f],parent:1});else for(f=0;f<c.length;f++)h.data.push({id:c[f],name:c[f],url:b+"/"+c[f],parent:1});
b=new v(h);b=new w({store:b,query:{root:!0}});b=new r({model:b,onClick:function(b){1===b.id?a.add(g.okButton,"jimu-state-disabled"):(a.remove(g.okButton,"jimu-state-disabled"),g.selectRouteURL=b.url)},getIconStyle:d.hitch(this,function(a){var b;if(!a||"root"===a.id)return null;b={width:"20px",height:"20px",backgroundRepeat:"no-repeat",backgroundPosition:"center center",backgroundImage:""};b.backgroundImage="url("+this.folderUrl+"images/"+(1===a.id?"group-layer.png":"route-layer.png")+")";return b})});
b.placeAt(e).startup();this.routeName&&1<h.data.length&&(b.set("paths",[["1",this.routeName]]),a.remove(this.okButton,"jimu-state-disabled"),this.selectRouteURL=h.data[1].url);this.loading.hide()},_resetRouteSearch:function(a,c){this._errorMessage(c);k.empty(a);this.loading.hide();this.serviceFlag=this.agolFlag=!1},_onBtnBackClicked:function(){a.remove(this.itemSelectDiv,"esriCTHidden");a.add(this.serviceUrlDiv,"esriCTHidden");a.add(this.agolRouteLayerList,"esriCTHidden");a.remove(this.btnNext,"esriCTHidden");
a.add(this.btnBack,"esriCTHidden")},_errorMessage:function(a){(new z({message:a})).message=a},_urlValidator:function(a){var b;b="^"+y.url({allowNamed:!0,allLocal:!1});b=(new RegExp(b,"g")).test(a);a=/\/Route\/NAServer/gi.test(a);return b&&a}})});;;;;
