...
"NW");return b},roundSeconds:function(a){a=Number(a);return 10>a?"0"+a:a},showFixedPlacesAfterDecimal:function(a,b){var c=0;b||(b=2);a=a.toString();c=a.indexOf(".");0<c&&(a=a.slice(0,c+b+1));return Number(a)},honourPopupRounding:function(a,b){var c;if(isNaN(a)||null===a)a=4;c=Math.pow(10,a);b=Math.round(b*c)/c;return b=b.toFixed(a)},convertBearingToOutputFormats:function(a){var b,c,e,f,g;b={};c={};360===a.degree&&(a.degree=0);b=a.decimalDegrees;360===b&&(b=0);c.naDD=b;c.naDDRound=d.honourPopupRounding(d.bearingFieldPlaces,
b);360===Number(c.naDDRound)&&(c.naDDRound=0);e=10>a.minutes?"0"+a.minutes:a.minutes;f=a.seconds;0<Number(e)&&0<Number(d.roundSeconds(f))?c.naDMS=a.degree+"-"+e+"-"+d.roundSeconds(f):0===Number(e)&&0<Number(d.roundSeconds(f))?c.naDMS=a.degree+"-"+e+"-"+d.roundSeconds(f):0<Number(e)&&0===Number(d.roundSeconds(f))?c.naDMS=a.degree+"-"+e+"-00":0===Number(e)&&0===Number(d.roundSeconds(f))&&(c.naDMS=a.degree+"-00-00");a=d.getQuadrantAngleAndShortcut(b);c.qb3DD=a.quadrant.charAt(0)+a.quadrantAngle+a.quadrant.charAt(1);
c.qb3DDRound=a.quadrant.charAt(0)+d.honourPopupRounding(d.bearingFieldPlaces,a.quadrantAngle)+a.quadrant.charAt(1);e=d.DDtoDMS({angle:a.quadrantAngle});f=10>e.minutes?"0"+e.minutes:e.minutes;g=e.seconds;0<Number(f)&&0<Number(d.roundSeconds(g))?c.qb3DMS=a.quadrant.charAt(0)+e.degree+"-"+f+"-"+d.roundSeconds(g)+a.quadrant.charAt(1):0===Number(f)&&0<Number(d.roundSeconds(g))?c.qb3DMS=a.quadrant.charAt(0)+e.degree+"-"+f+"-"+d.roundSeconds(g)+a.quadrant.charAt(1):0<Number(f)&&0===Number(d.roundSeconds(g))?
c.qb3DMS=a.quadrant.charAt(0)+e.degree+"-"+f+"-00"+a.quadrant.charAt(1):0===Number(f)&&0===Number(d.roundSeconds(g))&&(c.qb3DMS=a.quadrant.charAt(0)+e.degree+"-00-00"+a.quadrant.charAt(1));b=d.getSouthAzimuthFromNorthAzimuth(b);360===b&&(b=0);c.saDD=b;c.saDDRound=d.honourPopupRounding(d.bearingFieldPlaces,b);360===Number(c.saDDRound)&&(c.saDDRound=0);b=d.DDtoDMS({angle:b});360===b.degree&&(b.degree=0);a=10>b.minutes?"0"+b.minutes:b.minutes;e=b.seconds;0<Number(a)&&0<Number(d.roundSeconds(e))?c.saDMS=
b.degree+"-"+a+"-"+d.roundSeconds(e):0===Number(a)&&0<Number(d.roundSeconds(e))?c.saDMS=b.degree+"-"+a+"-"+d.roundSeconds(e):0<Number(a)&&0===Number(d.roundSeconds(e))?c.saDMS=b.degree+"-"+a+"-00":0===Number(a)&&0===Number(d.roundSeconds(e))&&(c.saDMS=b.degree+"-00-00");return c},getBearingDetailsOfRequiredFormat:function(a,b){var c={};switch(b){case 0:c=d.getBearingObjForFormat0(a);break;case 1:c=d.getBearingObjForFormat1(a);break;case 2:c=d.getBearingObjForFormat2(a);break;case 3:c=d.getBearingObjForFormat3(a);
break;case 4:c=d.getBearingObjForFormat4(a);break;case 5:c=d.getBearingObjForFormat5(a);break;case 6:c=d.getBearingObjForFormat6(a);break;case 7:c=d.getBearingObjForFormat7(a);break;case 8:c=d.getBearingObjForFormat8(a)}return d.convertBearingToOutputFormats(c)},getBearingFormatArr:function(){var a=[];a.push({regex:/^((?:\-)?(?:3[0-5]\d|[12]\d{2}|[1-9]\d?|0))(?:\-(0|[0-5]?\d)\-(0|[0-5]\d))?\-([1-4])$/,type:"degreeMinuteSeconds"});a.push({regex:/^([nNsS])((?:\-)?(?:3[0-5]\d|[12]\d{2}|[1-9]\d?|0))(?:\-(0|[0-5]?\d)\-(0|[0-5]\d))?([eEwW])$/,
type:"degreeMinuteSeconds"});a.push({regex:/^([nNsS])((?:\-)?(?:3[0-5]\d|[12]\d{2}|[1-9]\d?|0))(?:\.([0-5]\d)(?:([0-5]\d))?)?([eEwW])$/,type:"degreeMinuteSeconds"});a.push({regex:/^((?:\-)?(?:3[0-5]\d|[12]\d{2}|[1-9]\d?|0))(?:\.([0-5]\d)(?:([0-5]\d))?)?$/,type:"degreeMinuteSeconds"});a.push({regex:/^((?:(?:\-?)(?:3[0-5]\d|[12]\d{2}|[1-9]\d?|0)(?:\.\d+)?)|(?:\-?)(?:\.\d+))$/,type:"decimalDegree"});a.push({regex:/^((?:\-)?(?:3[0-5]\d|[12]\d{2}|[1-9]\d?|0))(?:\-(0|[0-5]?\d)\-((?:[0-5]\d)))?$/,type:"degreeMinuteSeconds"});
a.push({regex:/^((?:\-)?(?:3[0-5]\d|[12]\d{2}|[1-9]\d?|0))(?:\.([0-5]\d)(?:([0-5]\d))?)?(\-[1-4])$/,type:"degreeMinuteSeconds"});a.push({regex:/^([nNsS])((?:(?:\-?)(?:3[0-5]\d|[12]\d{2}|[1-9]\d?|0)(?:\.\d+)?)|(?:\-?)(?:\.\d+))([eEwW])$/,type:"decimalDegree"});a.push({regex:/^((?:(?:\-?)(?:3[0-5]\d|[12]\d{2}|[1-9]\d?|0)(?:\.\d+)?)|(?:\-?)(?:\.\d+))(\-[1-4])$/,type:"decimalDegree"});return a},getNorthAzimuthAngle:function(a,b){b=b.toUpperCase();a=Number(a);switch(b){case "-1":case "NE":return(a+360)%
360;case "-2":case "SE":return(540-a)%360;case "-3":case "SW":return(540+a)%360;case "-4":case "NW":return(360-a)%360}},convertBearingToNorthAzimuth:function(a,b,c){switch(b){case 0:b=d.getBearingObjForFormat0(a);b=d.getNorthAzimuthAngle(b.decimalDegrees,"-"+a[4]);b=d.DDtoDMS({angle:b});a[1]=b.degree;a[2]=b.minutes;a[3]=b.seconds;break;case 1:b=d.getBearingObjForFormat1(a);b=d.getNorthAzimuthAngle(b.decimalDegrees,a[1]+a[5]);b=d.DDtoDMS({angle:b});a[2]=b.degree;a[3]=b.minutes;a[4]=b.seconds;break;
case 2:b=d.getBearingObjForFormat2(a);b=d.getNorthAzimuthAngle(b.decimalDegrees,a[1]+a[5]);b=d.DDtoDMS({angle:b});a[2]=b.degree;a[3]=b.minutes;a[4]=b.seconds;break;case 3:"northAzimuth"===c.directionOrAngleType||"quadrantBearing"===c.directionOrAngleType?(b=d.getBearingObjForFormat3(a),b=d.getNorthAzimuthAngle(b.decimalDegrees,"-1"),b=d.DDtoDMS({angle:b}),a[1]=b.degree,a[2]=b.minutes,a[3]=b.seconds):"southAzimuth"===c.directionOrAngleType&&(b=d.getBearingObjForFormat3(a),b=d.getNorthAzimuthAngle(b.decimalDegrees,
"-3"),b=d.DDtoDMS({angle:b}),a[1]=b.degree,a[2]=b.minutes,a[3]=b.seconds);break;case 4:"northAzimuth"===c.directionOrAngleType||"quadrantBearing"===c.directionOrAngleType?a[1]=d.getNorthAzimuthAngle(a[1],"-1"):"southAzimuth"===c.directionOrAngleType&&(a[1]=d.getNorthAzimuthAngle(a[1],"-3"));break;case 5:"northAzimuth"===c.directionOrAngleType?(b=d.getBearingObjForFormat5(a),b=d.getNorthAzimuthAngle(b.decimalDegrees,"-1"),b=d.DDtoDMS({angle:b}),a[1]=b.degree,a[2]=b.minutes,a[3]=b.seconds):"southAzimuth"===
c.directionOrAngleType?(b=d.getBearingObjForFormat5(a),b=d.getNorthAzimuthAngle(b.decimalDegrees,"-3"),b=d.DDtoDMS({angle:b}),a[1]=b.degree,a[2]=b.minutes,a[3]=b.seconds):"quadrantBearing"===c.directionOrAngleType&&(a=null);break;case 6:b=d.getBearingObjForFormat6(a);b=d.getNorthAzimuthAngle(b.decimalDegrees,a[4]);b=d.DDtoDMS({angle:b});a[1]=b.degree;a[2]=b.minutes;a[3]=b.seconds;break;case 7:a[2]=d.getNorthAzimuthAngle(a[2],a[1]+a[3]);break;case 8:a[1]=d.getNorthAzimuthAngle(a[1],a[2])}return a},
categorizeBearingFormat:function(a,b){var c,e,f;a=a.toString();c=d.getBearingFormatArr();for(f=0;f<c.length;f++)if(c[f].type===b.directionOrAngleUnits&&(e=c[f].regex.exec(a.trim()))&&0<e.length){e=d.convertBearingToNorthAzimuth(e,f,b);break}if(!e)for(f=0;f<c.length;f++)if(c[f].type!==b.directionOrAngleUnits&&(e=c[f].regex.exec(a.trim()))&&0<e.length){e=d.convertBearingToNorthAzimuth(e,f,b);break}return e?d.getBearingDetailsOfRequiredFormat(e,f):null},metersToUSSurveyFeet:function(a){a=Number(a);return 3.28083333333*
a},usSurveyFeetToMeters:function(a){a=Number(a);return.304800609601*a},feetToUSSurveyFeet:function(a){a=Number(a);return d.metersToUSSurveyFeet(.3048*a)},feetToMeters:function(a){a=Number(a);return.3048*a},usSurveyFeetToFeet:function(a){a=Number(a);return 1.000001999999281*a},metersToFeet:function(a){a=Number(a);return 3.280839895*a},getLengthObjForFormat0:function(a,b){var c;c={};"uSSurveyFeet"===b?(c.uSSurveyFeet=Number(a[0]),c.uSSurveyFeetRound=Math.round(1E4*c.uSSurveyFeet)/1E4,c.meters=d.usSurveyFeetToMeters(a[0]),
c.metersRound=Math.round(1E4*c.meters)/1E4,c.feet=d.usSurveyFeetToFeet(c.uSSurveyFeet),c.feetRound=Math.round(1E4*c.feet)/1E4):"meters"===b&&(c.uSSurveyFeet=d.metersToUSSurveyFeet(a[0]),c.uSSurveyFeetRound=Math.round(1E4*c.uSSurveyFeet)/1E4,c.meters=Number(a[0]),c.metersRound=Math.round(1E4*c.meters)/1E4,c.feet=d.metersToFeet(c.meters),c.feetRound=Math.round(1E4*c.feet)/1E4);return c},getLengthObjForFormat1:function(a){var b;b={};b.uSSurveyFeet=Number(a[2]);b.uSSurveyFeetRound=Math.round(1E4*b.uSSurveyFeet)/
1E4;b.meters=d.usSurveyFeetToMeters(a[2]);b.metersRound=Math.round(1E4*b.meters)/1E4;b.feet=d.usSurveyFeetToFeet(b.uSSurveyFeet);b.feetRound=Math.round(1E4*b.feet)/1E4;return b},getLengthObjForFormat2:function(a){var b;b={};b.uSSurveyFeet=d.metersToUSSurveyFeet(a[2]);b.uSSurveyFeetRound=Math.round(1E4*b.uSSurveyFeet)/1E4;b.meters=Number(a[2]);b.metersRound=Math.round(1E4*b.meters)/1E4;b.feet=d.metersToFeet(b.meters);b.feetRound=Math.round(1E4*b.feet)/1E4;return b},getLengthObjForFormat3:function(a){var b;
