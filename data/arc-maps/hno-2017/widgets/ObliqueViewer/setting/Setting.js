...
"*now":function(e){e(['dojo/i18n!*preload*widgets/ObliqueViewer/setting/nls/Setting*["ar","bs","cs","da","de","en","el","es","et","fi","fr","he","hi","hr","id","it","ja","ko","lt","lv","nb","nl","pl","pt-br","pt-pt","ro","ru","sl","sr","sv","th","tr","zh-cn","vi","zh-hk","zh-tw","ROOT"]'])},"*noref":1}});
define("dojo/_base/declare dijit/_WidgetsInTemplateMixin jimu/BaseWidgetSetting dojo/_base/array dojo/dom-class dojo/dom-style dojo/html dojo/_base/lang esri/lang dojo/on dijit/form/CheckBox dijit/form/Select dojox/form/CheckedMultiSelect dijit/form/NumberTextBox dijit/form/NumberSpinner".split(" "),function(e,m,d,h,k,f,g,n,p){return e([d,m],{baseClass:"jimu-widget-ObliqueViewer-setting",_layerFieldMap:{},_hasSupportedLayer:!1,startup:function(){this.inherited(arguments);this.config.ObliqueViewer||
(this.config.ObliqueViewer={});this._populateLayers();this._hasSupportedLayer&&(this._populateFields(),this._setupRadiusSelector(),this._populateUnits());this.rasterInfoFieldsSelect&&(this._multiSelectClick(),this.own(this.rasterInfoFieldsSelect.on("click",n.hitch(this,this._multiSelectClick))));this.setConfig(this.config)},_setupRadiusSelector:function(){this.searchRadiusSelect.set("smallDelta",1);this.searchRadiusSelect.set("constraints",{min:0,max:100});this.searchRadiusSelect.set("rangeMessage",
this.nls.outOfRangeMessage)},_populateUnits:function(){var b=["meters","feet","yards","kilometers","miles"],c=Object.keys(window.jimuNls.units),d=this.searchUnitSelect;h.forEach(c,function(c){-1!=h.indexOf(b,c)&&d.addOption({label:window.jimuNls.units[c],value:c})},this);this.config.ObliqueViewer.searchUnit&&this.searchUnitSelect.set("value",this.config.ObliqueViewer.searchUnit)},_multiSelectClick:function(){var b=this.rasterInfoFieldsSelect.get("value");3<b.length?(f.set(this.fieldLimitLabel,"visibility",
"visible"),this.rasterInfoFieldsSelect.set("value",b.slice(0,3))):f.set(this.fieldLimitLabel,"visibility","hidden")},_checkForImageServiceLayers:function(){},_populateLayers:function(){var b=0;h.forEach(this.map.itemInfo.itemData.operationalLayers,function(c){c&&c.layerObject&&this._isImageServiceLayer(c.layerObject)&&(b++,this.mapLayerSelect.addOption({value:c.title,label:c.title}),this._layerFieldMap[c.title]=[],this._layerFieldMap[c.title]=c.layerObject.fields)},this);this.mapLayerSelect.on("change",
n.hitch(this,this._populateFields));0===b?(k.add(this.searchesSection,"settingsHidden"),g.set(this.errorSection,this.nls.errorSectionMessage),this._hasSupportedLayer=!1):(k.remove(this.searchesSection,"settingsHidden"),g.set(this.errorSection,""),this._hasSupportedLayer=!0)},_isImageServiceLayer:function(b){return"esri.layers.ArcGISImageServiceLayer"===b.declaredClass||"esri.layers.ArcGISImageServiceVectorLayer"===b.declaredClass},_populateFields:function(){var b=this.config.ObliqueViewer,c=b.rasterInfoFields&&
b.rasterInfoFields.length?b.rasterInfoFields:this._getDefaultFields(),d=b.elevationField?b.elevationField.toLowerCase():"elevation",b=b.azimuthField?b.azimuthField.toLowerCase():"azimuth";this._clearFields(this.elevationFieldSelect);this._clearFields(this.azimuthFieldSelect);this._clearFields(this.rasterInfoFieldsSelect);this._addFields(this.elevationFieldSelect,d);this._addFields(this.azimuthFieldSelect,b);this._addFields(this.rasterInfoFieldsSelect);this.rasterInfoFieldsSelect.set("value",c)},_clearFields:function(b){var c=
b.getOptions();h.forEach(c,function(c){b.removeOption(c)},this)},_addFields:function(b,c){var d=this._layerFieldMap[this.mapLayerSelect.get("value")],e;h.forEach(d,function(d){c&&-1<d.name.toLowerCase().indexOf(c)&&(e=d.name);"esriFieldTypeGeometry"!==d.type&&b.addOption({value:d.name,label:d.alias||d.name})},this);c&&b.set("value",e)},_getDefaultFields:function(){var b,c=this._layerFieldMap[this.mapLayerSelect.get("value")],d=[];if(!c||!c.length)return k.add(this.searchesSection,"settingsHidden"),
g.set(this.errorSection,this.nls.errorSectionMessage),console.log("No fields found.");for(b=0;3>b;b++)d.push(c[b].alias);return d},setConfig:function(b){this.config=b;this.thumbnailCheckbox.set("checked",this.config.ObliqueViewer.showThumbnail);this.autoSyncCheckbox.set("checked",this.config.ObliqueViewer.autoSync);this.distanceToolCheckbox.set("checked",this.config.ObliqueViewer.showDistanceTools);p.isDefined(this.config.ObliqueViewer.searchRadius)&&this.searchRadiusSelect.set("value",this.config.ObliqueViewer.searchRadius);
