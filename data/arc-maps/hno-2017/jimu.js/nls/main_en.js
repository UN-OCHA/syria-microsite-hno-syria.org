...
invalidSQL:"Invalid SQL expression.",cantParseSQL:"Can't parse the SQL expression."},caseSensitive:"Case sensitive",notSupportCaseSensitiveTip:"Hosted services do not support case-sensitive query.",setFilterTip:"Please set filters correctly.",listValues:"List values",cascadeFilterTip:"Only show values filtered by previous expressions.",noneCascadeFilterTip:"All unique values of this field",previousCascadeFilterTip:"Values filtered by previous expressions",allCascadeFilterTip:"Values filtered by all other expressions",
custom:"the date...",today:"today",yesterday:"yesterday",tomorrow:"tomorrow",thisWeek:"this week",thisMonth:"this month",thisQuarter:"this quarter",thisYear:"this year",inputType:"Input type",setInputType:"Set input type"},featureLayerSource:{layer:"Layer",browse:"Browse",selectFromMap:"Map",selectFromPortal:"Portal for ArcGIS",addServiceUrl:"Service URL",inputLayerUrl:"Input layer URL",selectLayer:"Select a feature layer from current map.",chooseItem:"Choose a feature layer item.",setServiceUrl:"Enter the URL of a feature service or a map service.",
selectFromOnline:"ArcGIS Online",chooseLayer:"Choose a feature layer."},queryableLayerSource:{layer:"Layer",browse:"Browse",selectFromMap:"Map",selectFromPortal:"Portal for ArcGIS",addServiceUrl:"Service URL",inputLayerUrl:"Input layer URL",selectLayer:"Select a layer from current map.",chooseItem:"Choose an item.",setServiceUrl:"Enter the URL of the service.",selectFromOnline:"ArcGIS Online",chooseLayer:"Choose a layer."},gpSource:{selectFromPortal:"Portal for ArcGIS",addServiceUrl:"Service URL",
selectFromOnline:"ArcGIS Online",setServiceUrl:"Enter the URL of a geoprocessing service.",chooseItem:"Choose a geoprocessing service item.",chooseTask:"Choose a geoprocessing task."},itemSelector:{map:"Map",selectWebMap:"Choose web map",addMapFromOnlineOrPortal:"Find and add a web map in the application from ArcGIS Online public resources or your private content in ArcGIS Online or Portal.",searchMapName:"Search by map name...",searchNone:"We couldn't find what you were looking for. Please try again.",
...
newSelectionTip:"Create new selection",addSelectionTip:"Add to selection",removeSelectionTip:"Remove from selection",selectFromCurrentSelectionTip:"Select from the current selection",unselectAllSelectionTip:"Unselect all currently selected features",selectByPolygon:"Select by polygon",selectByCircle:"Select by circle",selectByLine:"Select by line",chooseSelectingTools:"Choose selecting tools",darw:"Draw",drawShap:"Draw a shape"},widgetManager:{createWidgetError:"Create widget error",createWidgetSettingPageError:"Create widget setting page error",
