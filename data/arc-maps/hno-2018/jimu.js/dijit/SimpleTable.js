...
h.forEach(this.fields,g.hitch(this,function(b){var c=a[b.name],f=b.type,e=null;"actions"===f?e=this._createActionsTd(l,b):("text"===f?e=this._createTextTd(l,b,c):"radio"===f?e=this._createRadioTd(l,b,c):"checkbox"===f?e=this._createCheckboxTd(l,b,c):"empty"===f?e=this._createEmptyTd(l,b):"extension"===f&&(e=this._createExtensionTd(l,b,c)),b.hidden&&d.addClass(e,"hidden-column"))}));c||(this.updateUI(),c=this.getRows(),"number"===typeof b&&0<=b&&b<c.length&&d.place(l,c[b],"before"));e.success=!0;e.tr=
...
this.own(m(b,"click",g.hitch(this,function(b){b.stopPropagation();this.onBeforeRowDelete(a)&&this.deleteRow(a)}))))}));b=this._calculateActionsWidth(b)+"px";d.setStyle(e,"width",b);return c},_calculateActionsWidth:function(a){return 20*h.map(a.actions,function(a){return"up"===a||"down"===a||"edit"===a||"delete"===a}).length},_createEmptyTd:function(a,b){a=d.create("td",{"class":b.name},a);d.addClass(a,"simple-table-cell");d.addClass(a,"empty-text-td");b["class"]&&d.addClass(a,b["class"]);return a},
_createExtensionTd:function(a,b,c){a=d.create("td",{"class":b.name},a);d.addClass(a,"simple-table-cell");d.addClass(a,"extension-td");b["class"]&&d.addClass(a,b["class"]);b.create&&"function"===typeof b.create&&b.create(a);b.setValue&&"function"===typeof b.setValue&&b.setValue(a,c);return a},editRow:function(a,b){var c={success:!1,tr:null,errorCode:null,errorMessage:null,repeatFields:null};if(!this.fields||"object"!==typeof b||!d.isDescendant(a,this.tbody))return c;var e=g.mixin([],this.fields),e=
h.filter(e,g.hitch(this,function(a){return"text"===a.type&&!0===a.unique})),e=h.filter(e,g.hitch(this,function(c){return 0<this.getRowDataArrayByFieldValue(c.name,b[c.name],a).length}));if(0<e.length)return c.errorCode=this.REPEATING_ERROR,c.errorMessage="repeating data",c.repeatFields=e,c;var f=k(".simple-table-cell",a);h.forEach(this.fields,g.hitch(this,function(a,c){if(b.hasOwnProperty(a.name)){c=f[c];var d=b[a.name],e=a.type;"text"===e?a.editable?this._editEditableText(c,a,d):this._editNormalText(c,
