...
"*now":function(r){r(['dojo/i18n!*preload*themes/JewelryBoxTheme/widgets/HeaderController/nls/Widget*["ar","bs","cs","da","de","en","el","es","et","fi","fr","he","hi","hr","id","it","ja","ko","lt","lv","nb","nl","pl","pt-br","pt-pt","ro","ru","sl","sr","sv","th","tr","zh-cn","vi","zh-hk","zh-tw","ROOT"]'])},"*noref":1}});
define("dojo/_base/declare dojo/_base/lang dojo/_base/array dojo/_base/html dojo/aspect dojo/query dojo/on dojo/Deferred dojo/mouse dojo/dom-construct dojo/dom-geometry jimu/BaseWidget jimu/PoolControllerMixin jimu/tokenUtils jimu/portalUtils jimu/portalUrlUtils jimu/utils jimu/dijit/Message ./PopupTileNodes dojo/NodeList-manipulate".split(" "),function(r,e,p,b,n,h,m,u,w,v,t,d,f,g,l,q,k,y,z){return r([d,f],{baseClass:"jimu-widget-header-controller jimu-main-background",maxIconCount:-1,createMoreIcon:!1,
...
"px"});b.setStyle(this.subtitleNode,{lineHeight:this.height+"px"});h(".jimu-link",this.domNode).style({lineHeight:this.height+"px"})},_processGroupSetting:function(){p.forEach(this.appConfig.widgetPool.groups,function(a){var c;a:{if(this.config.groupSetting)for(c=0;c<this.config.groupSetting.length;c++)if(this.config.groupSetting[c].label===a.label){c=this.config.groupSetting[c].type;break a}c="openAll"}a.openType=c},this)},_createDynamicLinks:function(a){if(window.isRTL){var c=[];p.forEach(a,function(a){c.unshift(a)});
a=c}b.empty(this.dynamicLinksNode);p.forEach(a,function(a){b.create("a",{href:a.url,target:"_blank",rel:"noopener noreferrer",innerHTML:k.sanitizeHTML(a.label),"class":"jimu-link jimu-align-leading jimu-leading-margin1",style:{lineHeight:this.height+"px"}},this.dynamicLinksNode)},this)},_showSwitchableElements:function(a){var c=this.switchableElements,d;for(d in c)c.hasOwnProperty(d)&&(-1<a.indexOf(d)?(b.setStyle(c[d],"display","block"),c[d].visible=!0):(b.setStyle(c[d],"display","none"),c[d].visible=
!1));this.logoClickHandle&&this.logoClickHandle.remove();0>a.indexOf("links")?this.logoClickHandle=m(this.logoNode,"click",e.hitch(this,this._onLogoClick)):this.popupLinksVisible&&this._hidePopupLink()},_switchSignin:function(){var a=g.getPortalCredential(this.appConfig.portalUrl);if(a)this.onSignIn(a);else this.onSignOut()},_onLogoClick:function(){this.popupLinkNode&&b.destroy(this.popupLinkNode);this.popupLinkNode=this._createPopupLinkNode();this.popupLinksVisible?this._hidePopupLink():this._showPopupLink()},
_hidePopupLink:function(){b.setStyle(this.popupLinkNode,"display","none");window.isRTL?b.setStyle(jimuConfig.layoutId,{right:0}):b.setStyle(jimuConfig.layoutId,{left:0});this.popupLinksVisible=!1},_showPopupLink:function(){b.setStyle(this.popupLinkNode,"display","");window.isRTL?b.setStyle(jimuConfig.layoutId,{right:b.getContentBox(this.popupLinkNode).w+"px"}):b.setStyle(jimuConfig.layoutId,{left:b.getContentBox(this.popupLinkNode).w+"px"});this.popupLinksVisible=!0},_createPopupLinkNode:function(){var a,
c;b.getContentBox(jimuConfig.mainPageId);a=b.create("div",{"class":"popup-links jimu-main-background",style:{position:"absolute",zIndex:100,top:0,bottom:0}},jimuConfig.mainPageId);window.isRTL?b.setStyle(a,{right:0,left:"50px"}):b.setStyle(a,{left:0,right:"50px"});c=b.create("div",{"class":"popup-title",style:{height:this.height+"px",width:"100%"}},a);var d=b.create("img",{"class":"logo jimu-float-leading jimu-leading-margin1",src:this.appConfig.logo?this.appConfig.logo:this.folderUrl+"images/app-logo.png",
style:{width:"30px",height:"30px",marginTop:(this.height-30)/2+"px"}},c),e=b.create("div",{"class":"title jimu-float-leading jimu-leading-margin1 jimu-ellipsis",innerHTML:k.sanitizeHTML(this.appConfig.title),style:{lineHeight:this.height+"px"}},c),f="auto";try{f=b.getMarginBox(c).w-b.getMarginBox(d).w-b.getMarginExtents(e).w+"px"}catch(A){console.error(A),f="auto"}b.setStyle(e,"width",f);p.forEach(this.appConfig.links,function(c){this._createLinkNode(a,c,!1)},this);this._createLinkNode(a,{label:"",
url:"#"},!1);return a},_createLinkNode:function(a,c,d){a=b.place('\x3cdiv class\x3d"jimu-link"\x3e\x3c/div\x3e',a);b.place('\x3cdiv class\x3d"line"\x3e\x3c/div\x3e',a);d=b.place('\x3cdiv class\x3d"'+(d?"link-section signin":"link-section")+'"\x3e\x3c/div\x3e',a);b.create("a",{href:c.url,"class":"jimu-ellipsis",target:"_blank",rel:"noopener noreferrer",innerHTML:k.sanitizeHTML(c.label),title:c.label,style:{lineHeight:"66px"}},d);return a},_onSigninClick:function(){g.signInPortal(this.appConfig.portalUrl,
...
a.w},_createIconNodes:function(a){h(".icon-node",this.containerNode).remove();this._closeDropMenu();var c,d=this.getAllConfigs();this.iconWidth=a.h;a=this._calcContainerAndEmptyWidth(a);c={width:a.containerWidth+"px"};c[window.isRTL?"marginRight":"marginLeft"]=a.emptyWidth-5+"px";b.setStyle(this.containerNode,c);this.maxIconCount=Math.floor(a.containerWidth/this.iconWidth);this.maxIconCount>=d.length?(this.headerIconCount=d.length,this.createMoreIcon=!1):(this.headerIconCount=this.maxIconCount-1,
this.createMoreIcon=!0);this.createMoreIcon&&this._createIconNode({label:this.nls.more,name:"__more"});var e;for(a=this.headerIconCount-1;0<=a;a--){c=d[a];var f=this._createIconNode(c);c.openAtStart&&(e=f)}e&&!this.openAtStartWidget&&(this.openAtStartWidget=e.config.id,this._onIconClick(e));this.openedId&&this.getConfigById(this.openedId)&&!1===this.getConfigById(this.openedId).inPanel&&(d=this._getIconNodeById(this.openedId),e=this.widgetManager.getWidgetById(this.openedId),d&&e?this._setOffPanelWidgetPosition(d,
e):(this.widgetManager.closeWidget(this.openedId),this.openedId=""))},_createIconNode:function(a){var c,d;d="__more"===a.name?this.folderUrl+"images/more_icon.png":a.icon;c=b.create("div",{"class":"icon-node jimu-float-trailing"+(this.openedId===a.id?" jimu-state-selected":""),title:a.label,settingId:a.id,style:{width:this.height+"px",height:this.height+"px"}},this.containerNode);b.create("img",{src:d,style:{marginTop:(this.height-24)/2+"px"}},c);"__more"===a.name?m(c,"click",e.hitch(this,this._showMorePane,
a)):m(c,"click",e.hitch(this,function(){this._onIconClick(c)}));c.config=a;c.config.widgets&&1<c.config.widgets.length&&"dropDown"===c.config.openType&&this._createDropTriangle(c);return c},_createDropTriangle:function(a){var c=b.getMarginBox(a);b.create("div",{"class":"drop-triangle",style:{left:c.l+c.w/2-4+"px"}},a)},_onIconClick:function(a){a.config.widgets&&1!==a.config.widgets.length&&"openAll"!==a.config.openType?this.dropMenuNode?this._closeDropMenu():this._openDropMenu(a):this.openedId&&this.openedId===
...
b.place(this.dropMenuNode,this.containerNode);p.forEach(a.config.widgets,function(a){this._createDropMenuItem(a)},this);this._setDropMenuPosition(a);this.morePane&&this.morePane.hide()},_createDropMenuItem:function(a){var c=b.create("div",{"class":"menu-item",title:a.label,style:{height:this.height+"px"}},this.dropMenuNode);b.create("img",{"class":"jimu-float-leading",src:a.icon},c);b.create("div",{"class":"label jimu-float-leading",innerHTML:k.sanitizeHTML(a.label)},c);this.own(m(c,"click",e.hitch(this,
function(){this._closeDropMenu();this.openedId?this._switchNodeToClose(this.openedId).then(e.hitch(this,function(){this._showIconContent(c.config)})):this._showIconContent(c.config)})));c.config=a;return c},_setDropMenuPosition:function(a){var c={},c=b.getMarginBox(this.dropMenuNode),c=this._getDropdownPosition(a,c);c.zIndex=101;b.setStyle(this.dropMenuNode,k.getPositionStyle(c))},_getDropdownPosition:function(a,c){var d={};a=b.getMarginBox(a);var e=b.getMarginBox(this.domNode);d.top=this.height+
1;window.isRTL?d.right=0>a.l+a.w-c.w?0:a.l+a.w-c.w:a.l+c.w>e.w?d.right=0:d.left=a.l;return d},_switchNodeToOpen:function(a){a=this._getIconNodeById(a);h(".icon-node",this.domNode).removeClass("jimu-state-selected");b.addClass(a,"jimu-state-selected");this._showIconContent(a.config)},_switchNodeToClose:function(a){h(".icon-node",this.domNode).removeClass("jimu-state-selected");var b=this.appConfig.getConfigElementById(a);if(b)return!1===b.inPanel?(this.widgetManager.closeWidget(a),this.openedId="",
a=new u,a.resolve(),a):this.panelManager.closePanel(a+"_panel");a=new u;a.resolve();return a},_getIconNodeById:function(a){a=h('.icon-node[settingId\x3d"'+a+'"]',this.domNode);if(0!==a.length)return a[0]},_unSelectIcon:function(a){h('.icon-node[settingId\x3d"'+a+'"]',this.domNode).removeClass("jimu-state-selected");this.openedId=""},_showIconContent:function(a){!1===a.inPanel?this.widgetManager.loadWidget(a).then(e.hitch(this,function(c){this.openedId=a.id;var d=this._getIconNodeById(a.id);b.setStyle(c.domNode,
"zIndex",101);this._setOffPanelWidgetPosition(d,c);this.widgetManager.openWidget(c);this.own(n.after(c,"onClose",e.hitch(this,function(){this._unSelectIcon(a.id)})))})):this.panelManager.showPanel(a).then(e.hitch(this,function(b){this.openedId=a.id;this.own(n.after(b,"onClose",e.hitch(this,function(){this._unSelectIcon(a.id)})))}))},_setOffPanelWidgetPosition:function(a,b){a=this._getDropdownPosition(a,this.widgetManager.getWidgetMarginBox(b));b.setPosition(a,this.containerNode)},_showMorePane:function(){var a,
c,d=[],f=this.getAllConfigs();for(a=this.headerIconCount;a<f.length;a++)c=f[a],d.push(c);this.morePane&&this.morePane.destroy();this.moreIconPaneCoverNode&&b.destroy(this.moreIconPaneCoverNode);this._closeDropMenu();this.morePane=new z({openedId:this.openedId,items:d});this._createCoverNode();b.place(this.morePane.domNode,jimuConfig.mapId);this.morePane.startup();n.after(this.morePane,"onNodeClicked",e.hitch(this,function(a){this._moveConfigToHeader(a.config);this._createIconNodes(b.getContentBox(this.domNode));
this._onIconClick(this._getIconNodeById(a.config.id))}),!0);n.after(this.morePane,"hide",e.hitch(this,function(){b.destroy(this.moreIconPaneCoverNode)}),!0)},_moveConfigToHeader:function(a){var b=this.getAllConfigs(),d=a.index;a.index=b[this.headerIconCount-1].index;b[this.headerIconCount-1].index=d},_createCoverNode:function(){this.moreIconPaneCoverNode=b.create("div",{"class":"jimu-more-icon-cover"},jimuConfig.layoutId)}})});;;;;
