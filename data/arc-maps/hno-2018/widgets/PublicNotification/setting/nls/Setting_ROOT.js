...
rasterResolution:"Raster resolution",searchFields:"Search fields",showAlignmentAids:"Show alignment aids on page",showGridTickMarks:"Show grid tick marks",showLabelOutlines:"Show label outlines",showPopupForFoundItem:"Show pop-up for the found feature or location",tool:"Tools",units:"Units",url:"URL",urlToGeometryService:"URL to geometry service",useRelatedRecords:"Use its related records",useSecondarySearchLayer:"Use secondary selection layer",useVectorFonts:"Use vector fonts (Latin fonts only)",
zoomScale:"Zoom scale"},buttons:{addAddressSource:"Add layer containing address labels in its popup",addLabelFormat:"Add a label format",addSearchSource:"Add a search source",set:"Set"},placeholders:{averyExample:"e.g., Avery(r) label ${averyPartNumber}",countryRegionCodes:"e.g., USA,CHN",descriptionCSV:"Comma-separated values",descriptionPDF:"PDF label ${heightLabelIn} x ${widthLabelIn} inches; ${labelsPerPage} per page"},tooltips:{getWebmapFeatureLayer:"Get the feature layer from the webmap",openCountryCodes:"Click to get more information about codes",
openFieldSelector:"Click to open a field selector",setAndValidateURL:"Set and validate the URL"},_localized:{ar:1,bs:1,cs:1,da:1,de:1,el:1,es:1,et:1,fi:1,fr:1,he:1,hi:1,hr:1,id:1,it:1,ja:1,ko:1,lt:1,lv:1,nb:1,nl:1,pl:1,"pt-br":1,"pt-pt":1,ro:1,ru:1,sl:1,sr:1,sv:1,th:1,tr:1,vi:1,"zh-cn":1,"zh-hk":1,"zh-tw":1}}});;;;;
