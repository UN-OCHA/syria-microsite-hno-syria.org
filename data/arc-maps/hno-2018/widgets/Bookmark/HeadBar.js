...
define("dojo/Evented dojo/_base/declare dojo/_base/lang dojo/_base/html dojo/on dijit/_WidgetBase dijit/_TemplatedMixin dijit/_WidgetsInTemplateMixin dojo/text!./HeadBar.html".split(" "),function(e,f,b,a,c,g,h,k,l){return f([g,h,k,e],{baseClass:"dojoDndSource dojoDndTarget dojoDndContainer",templateString:l,nls:null,map:null,bookmarksContainer:null,layout:null,editingName:!1,initMapState:null,postMixInProperties:function(){this.nls=b.mixin(this.nls,window.jimuNls.common)},startup:function(){this.inherited(arguments);
this.refreshUI();this.own(c(this.addBtn,"click",b.hitch(this,function(){this.addingBookmark()})));this.own(c(this.filterInput,"blur",b.hitch(this,this.onFilterChange)));this.own(c(this.filterInput,"keyUp",b.hitch(this,this.onFilterChange)));this.own(c(this.cardsBtn,"click",b.hitch(this,function(){this._toggleLayoutBtnDisplay("cards")})));this.own(c(this.listBtn,"click",b.hitch(this,function(){this._toggleLayoutBtnDisplay("list")})))},refreshUI:function(){this.editable?(a.addClass(this.domNode,"editable"),
a.removeClass(this.addBtn,"hide")):(a.removeClass(this.domNode,"editable"),a.addClass(this.addBtn,"hide"));this._toggleLayoutBtnDisplay(this.layout.defaultMode);!1!==this.editable||!0===this.layout.list&&!0===this.layout.cards?a.removeClass(this.domNode,"hide"):a.addClass(this.domNode,"hide")},_toggleLayoutBtnDisplay:function(d){a.addClass(this.listBtn,"hide");a.addClass(this.cardsBtn,"hide");"list"===d?this.listMode():this.cardsMode();!0===this.layout.list&&!0===this.layout.cards?("list"===d?a.removeClass(this.cardsBtn,
"hide"):a.removeClass(this.listBtn,"hide"),a.addClass(this.displayMode,"two-modes")):a.removeClass(this.displayMode,"two-modes")},cardsMode:function(){a.removeClass(this.bookmarksContainer,"list");a.addClass(this.bookmarksContainer,"cards");a.addClass(this.domNode,"list");a.removeClass(this.domNode,"cards");this.emit("layout-cards")},listMode:function(){a.removeClass(this.bookmarksContainer,"cards");a.addClass(this.bookmarksContainer,"list");a.addClass(this.domNode,"cards");a.removeClass(this.domNode,
"list");this.emit("layout-list")},toogleMobileDisplay:function(d){d?a.addClass(this.displayMode,"hide"):a.removeClass(this.displayMode,"hide")},addingBookmark:function(){this.emit("add")},onFilterChange:function(){var a=this.filterInput.getValue();this.emit("filter-change",a)},onFilterBlur:function(){var a=this.filterInput.getValue();this.emit("filter-blur",a)}})});;;;;
