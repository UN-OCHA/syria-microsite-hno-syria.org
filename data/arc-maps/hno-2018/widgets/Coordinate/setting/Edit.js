...
disabled:!1},{value:"DECIMAL_DEGREES",label:"Decimal_Degrees",selected:!1,disabled:!1},{value:"DEGREES_DECIMAL_MINUTES",label:"Degrees_Decimal_Minutes",selected:!1,disabled:!1},{value:"DEGREE_MINUTE_SECONDS",label:"Degree_Minutes_Seconds",selected:!1,disabled:!1},{value:"",label:"",selected:!0,disabled:!1},{value:"MGRS",label:"MGRS",selected:!1,disabled:!1},{value:"USNG",label:"USNG",selected:!1,disabled:!1}];return k([m,l],{baseClass:"jimu-coordinate-edit",templateString:p,currentWkid:null,version:null,
enhanceVersion:10.1,_config:null,postCreate:function(){this.inherited(arguments);this.transformForward=new n({label:this.nls.forward,checked:!1},this.transformForward);this.version<this.enhanceVersion?(c.setStyle(this.olderVersionDiv,"display","block"),c.setStyle(this.enhanceVersionDiv,"display","none")):(c.setStyle(this.olderVersionDiv,"display","none"),c.setStyle(this.enhanceVersionDiv,"display","block"));c.setStyle(this.transformDiv,"display","none");c.setStyle(this.transformForward.domNode,"display",
"none");this.wkid.set("missingMessage",this.nls.warning);this.transformationWkid.set("missingMessage",this.nls.tfWarning)},setConfig:function(a){this._config=f.clone(a);b.loadResource().then(f.hitch(this,function(){a.wkid&&(this.wkid.set("value",parseInt(a.wkid,10)),this.currentWkid=parseInt(a.wkid,10),this._adjustUnitOption());a.label&&(this.wkidLabel.innerHTML=a.label);a.outputUnit&&this.outputUnit.set("value",a.outputUnit);a.transformationWkid&&this.transformationWkid.set("value",parseInt(a.transformationWkid,
10));a.transformationLabel&&(this.transformationLabel.innerHTML=a.transformationLabel);a.transformForward&&this.transformForward.setValue(a.transformForward)}),f.hitch(this,function(a){console.error(a)}))},getConfig:function(){var a={wkid:b.standardizeWkid(this.wkid.get("value")),label:this.wkidLabel.innerHTML,outputUnit:this.outputUnit.get("value"),transformationWkid:parseInt(this.transformationWkid.get("value"),10),transformationLabel:this.transformationLabel.innerHTML,transformForward:this.transformForward.getValue()};
a.outputUnit=a.outputUnit||b.getCSUnit(a.wkid);var d={sameSRWithMap:b.isSameSR(a.wkid,this.map.spatialReference.wkid),isGeographicCS:b.isGeographicCS(a.wkid),isGeographicUnit:b.isGeographicUnit(a.outputUnit),isProjectedCS:b.isProjectedCS(a.wkid),isProjectUnit:b.isProjectUnit(a.outputUnit),spheroidCS:b.isProjectedCS(a.wkid)?b.getGeoCSByProj(a.wkid):a.wkid,defaultUnit:b.getCSUnit(a.wkid),unitRate:b.getUnitRate(b.getCSUnit(a.wkid),a.outputUnit)};"DEGREES_DECIMAL_MINUTES"===a.outputUnit&&(d.isGeographicUnit=
!0,d.unitRate=1);d.isGeographicUnit&&d.isProjectedCS&&(d.unitRate=1);a.options=d;return a},_removeGeoUnits:function(){h.forEach(b.getGeographicUnits(),f.hitch(this,function(a){this.outputUnit.removeOption(a)}));this.outputUnit.removeOption("DEGREES_DECIMAL_MINUTES")},_removeProjUnits:function(){h.forEach(b.getProjectUnits(),f.hitch(this,function(a){this.outputUnit.removeOption(a)}))},_removeAllUnits:function(){for(var a=0,b=g.length;a<b;a++)this.outputUnit.removeOption(g[a].value)},_addAllUnits:function(){for(var a=
0,b=g.length;a<b;a++){var c=f.clone(g[a]);c.label=this.nls[g[a].label];this.outputUnit.addOption(c)}},_adjustUnitOption:function(){if(this.currentWkid===this.map.spatialReference.wkid){if(b.isWebMercator(this.currentWkid))return;4326===this.currentWkid?this._removeProjUnits():b.isGeographicCS(this.currentWkid)?this._removeProjUnits():b.isProjectedCS(this.currentWkid)&&(this._removeGeoUnits(),this.outputUnit.removeOption("USNG"),this.outputUnit.removeOption("MGRS"))}else b.isGeographicCS(this.currentWkid)&&
this._removeProjUnits();this._config.outputUnit&&this.outputUnit.set("value",this._config.outputUnit)},_isDefaultSR:function(){var a=this.wkid.get("value");return b.isSameSR(a,this.map.spatialReference.wkid)},onWkidChange:function(a){var d="",e=parseInt(a,10);this.popup.disableButton(0);b.isValidWkid(e)?(d=b.getSRLabel(e),this.wkidLabel.innerHTML=d,b.isSameSpheroid(e,this.map.spatialReference.wkid)?(this.transformationWkid.set("value",""),c.setStyle(this.transformDiv,"display","none")):c.setStyle(this.transformDiv,
"display","block"),this.popup.enableButton(0)):a&&(this.wkid.set("value",""),this.wkidLabel.innerHTML=this.nls.cName);this.currentWkid!==e&&this.transformationWkid.set("value","");this.currentWkid=e;this._removeAllUnits();this._addAllUnits();this._adjustUnitOption();this.outputUnit.closeDropDown()},ontfWkidChange:function(a){if(a){var d="",e="";a=parseInt(a,10);b.isValidTfWkid(a)?(d=a,e=b.getTransformationLabel(a),this.transformationLabel.innerHTML=e,c.setStyle(this.transformForward.domNode,"display",
"block")):(this.transformationLabel.innerHTML=this.nls.tName,c.setStyle(this.transformForward.domNode,"display","none"));this.transformationWkid.set("value",d)}else this.transformationLabel.innerHTML=this.nls.tName,c.setStyle(this.transformForward.domNode,"display","none")}})});;;;;
