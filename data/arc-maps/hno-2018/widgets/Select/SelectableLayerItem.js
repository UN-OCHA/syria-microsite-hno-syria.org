...
layerInfo:this.layerInfo}))},turnOn:function(){a.addClass(this.selectableCheckBox,"checked");this.checked=!0},turnOff:function(){a.removeClass(this.selectableCheckBox,"checked");this.checked=!1},toggleChecked:function(){(this.checked=!this.checked)?a.addClass(this.selectableCheckBox,"checked"):a.removeClass(this.selectableCheckBox,"checked")},_toggleChecked:function(b){f.stop(b);a.toggleClass(this.selectableCheckBox,"checked");this.checked=a.hasClass(this.selectableCheckBox,"checked");this.emit("stateChange",
{checked:this.checked,layerInfo:this.layerInfo})},_toggleContent:function(b){f.stop(b);a.hasClass(this.domNode,"no-action")||this.emit("switchToDetails",this)},_showActions:function(b){f.stop(b);if(!a.hasClass(this.domNode,"no-action")){var c=this.featureLayer.getSelectedFeatures(),e=k.toFeatureSet(c);this.popupMenu.prepareActions(e,this.allowExport).then(d.hitch(this,function(){var a=h.position(b.target);0<c.length&&this.popupMenu.appendAction(new r({folderUrl:this.folderUrl,data:this.featureLayer}));
