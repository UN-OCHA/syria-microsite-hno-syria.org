...
c.addClass(this.domNode,"infographic-number-dijit");b.horizontal&&c.addClass(this.domNode,"horizontal-"+b.horizontal);b.vertical&&c.addClass(this.domNode,"vertical-"+b.vertical)}a.link?c.setAttr(this.numberContent,"href",a.link):c.removeAttr(this.numberContent,"href")}},_setValueColor:function(a){d.set(this.number,"color",a)},_tryLocaleNumber:function(a){var b=a;if(k.isDefined(a)&&isFinite(a))try{var c=e.localizeNumber(a);"string"===typeof c&&(b=c)}catch(q){console.error(q)}return b+""}})});;;;;
