...
define("dojo/_base/lang dojo/Deferred dojo/json dojo/_base/array dojo/promise/all esri/SpatialReference jimu/portalUtils jimu/shared/basePortalUrlUtils esri/request dojo/text!./esri_tileinfo.json".split(" "),function(g,k,u,m,v,p,l,w,x,y){function q(a){if(!a)return null;var b=a.indexOf("?");return 0===a.search(/http|\/\//)&&-1!==b?a.slice(0,b).replace(/\/*$/g,""):a}function f(a){return a?w.removeProtocol(q(a)):""}function z(a){var b=new k;l.getPortalSelfInfo(a).then(g.hitch(this,function(c){var d=
c.basemapGalleryGroupQuery;!0===c.useVectorBasemaps&&c.vectorBasemapGalleryGroupQuery&&(d=c.vectorBasemapGalleryGroupQuery);e.getBasemapGalleryGroup(a,d).then(g.hitch(this,function(a){a.queryItems({start:1,num:100,f:"json",q:l.webMapQueryStr}).then(g.hitch(this,function(a){b.resolve(a)}),g.hitch(this,function(){b.reject()}))}),g.hitch(this,function(){b.reject()}))}));return b}function r(a){return x({url:a,content:{f:"json"},handleAs:"json",callbackParamName:"callback"}).then(function(a){return a},
function(){return null})}var e={},A=u.parse(y);e._loadPortalBaseMaps=function(a,b){var c=new k,d=[];z(a).then(function(a){m.forEach(a.results,function(a){var c=new k,n=f(a.thumbnailUrl);d.push(c);a.getItemData().then(function(d){e._getBasemapSpatialReference(a,d).then(g.hitch(this,function(h){var t=d.baseMap.baseMapLayers;e.isBasemapCompatibleWithMap(h,t,b).then(g.hitch(this,function(b){b?c.resolve({layers:t,title:a.title||d.baseMap.title,thumbnailUrl:n,spatialReference:h}):c.resolve({})}))}))})});
v(d).then(function(a){a=m.filter(a,function(a){return a&&a.title?!0:!1},this);c.resolve(a)})},function(a){c.reject(a)});return c};e.isBasemapCompatibleWithMap=function(a,b,c){var d=new k,n=c.spatialReference,h=c.width>c.height?c.width:c.height;if(!n||!b||0>=b.length||!a||!n.equals(new p(+a.wkid)))return d.resolve(!1),d;0===c.getNumLevels()?"OpenStreetMap"===b[0].layerType||b[0].layerType&&-1<b[0].layerType.indexOf("BingMaps")||"WebTiledLayer"===b[0].layerType||"VectorTileLayer"===b[0].layerType||
"ArcGISImageServiceVectorLayer"===b[0].layerType||"ArcGISTiledImageServiceLayer"===b[0].layerType?d.resolve(!1):d.resolve(!0):b[0].layerType&&0===b[0].layerType.indexOf("ArcGIS")&&b[0].url?r(b[0].url).then(function(a){(b[0].serviceInfoResponse=a)&&a.tileInfo?d.resolve(e.tilingSchemeCompatible(c.__tileInfo,a.tileInfo,h)):a&&a.capabilities&&(0<=a.capabilities.indexOf("Map")||0<=a.capabilities.indexOf("Image"))?d.resolve(!0):d.resolve(!1)}):"WMS"===b[0].layerType?d.resolve(!0):e.isNoUrlLayerMap(b)||
...
spatialReference:new p(a)}})};e.getBasemapGalleryGroup=function(a,b){var c=new k;a=l.getPortal(a);var d=b.indexOf("esri_");if(0<=d){var d=b.slice(d,d+7),e="esri_"+dojoConfig.locale.slice(0,2);b=b.replace(d,e)}a.queryGroups({f:"json",q:b}).then(g.hitch(this,function(a){0<a.results.length?c.resolve(a.results[0]):c.reject()}),g.hitch(this,function(){c.reject()}));return c};e._getBasemapSpatialReference=function(a,b){var c=null,d=!1,f=new k;if(a.owner&&0===a.owner.indexOf("esri_")||e.isNoUrlLayerMap(b.baseMap.baseMapLayers))c=
{wkid:"102100"};else if(b.spatialReference||a.spatialReference)c=b.spatialReference||a.spatialReference;else if(b.baseMap.baseMapLayers&&b.baseMap.baseMapLayers[0])if(a=b.baseMap.baseMapLayers[0],a.url&&0<a.url.indexOf("rest/services"))d=!0,r(b.baseMap.baseMapLayers[0].url).then(g.hitch(this,function(a){a&&a.spatialReference&&(c=a.spatialReference);f.resolve(c)}),function(a){console.error(a);f.resolve(null)});else if("VectorTileLayer"===a.layerType)c={wkid:"102100"};else if(b=a.fullExtent||a.initialExtent)c=
