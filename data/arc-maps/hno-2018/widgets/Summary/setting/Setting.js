...
"*now":function(f){f(['dojo/i18n!*preload*widgets/Summary/setting/nls/Setting*["ar","bs","cs","da","de","en","el","es","et","fi","fr","he","hi","hr","id","it","ja","ko","lt","lv","nb","nl","pl","pt-br","pt-pt","ro","ru","sl","sr","sv","th","tr","zh-cn","vi","zh-hk","zh-tw","ROOT"]'])},"*noref":1}});
define("dojo/_base/declare dojo/_base/array dojo/_base/html dojo/_base/lang dojo/dom-style dojo/on dojo/query dijit/_WidgetsInTemplateMixin dijit/form/Select dijit/form/ValidationTextBox jimu/BaseWidgetSetting jimu/dijit/Message jimu/dijit/SimpleTable".split(" "),function(f,e,g,d,n,h,k,p,l,q,r,m){return f([r,p],{baseClass:"jimu-widget-summary-setting",summaryLayer:null,summaryFields:null,filterFields:null,layerFields:null,summaryTypes:null,postCreate:function(){this.inherited(arguments);this.summaryTypes=
[{value:"SUM",label:this.nls.sum},{value:"AVG",label:this.nls.avg},{value:"MIN",label:this.nls.min},{value:"MAX",label:this.nls.max}];this.own(h(this.btnAddSummaryField,"click",d.hitch(this,this._addSummaryFieldRow)));this.own(h(this.summaryTable,"row-delete",d.hitch(this,function(a){a.select&&(a.select.destroy(),delete a.select)})));this.own(h(this.showFeatureCount,"change",d.hitch(this,function(){this.showFeatureCount.checked?this.featureCountLabel.set("readOnly",!1):this.featureCountLabel.set("readOnly",
!0)})));this.setConfig(this.config);this._setLayers()},_setLayers:function(){var a=this.map.itemInfo.itemData.operationalLayers,b=[];a&&0===a.length?new m({message:this.nls.missingLayerInWebMap}):(e.forEach(a,d.hitch(this,function(a){if("ArcGISFeatureLayer"===a.layerType)if(a.featureCollection)for(var c=0;c<a.featureCollection.layers.length;c++){var d=a.featureCollection.layers[c].layerObject,e=a.title;0<c&&(e+=": "+c);b.push({label:e,value:d.id})}else a.layerObject&&b.push({label:a.title,value:a.id})})),
0===b.length?(n.set(this.btnAddSummaryField,"display","none"),new m({message:this.nls.missingLayerInWebMap})):(this.selectLayer=(new l({name:"selectLayer",options:b})).placeAt(this.opLayers),a=this.config.summaryLayer.id?this.config.summaryLayer.id:b[0].value,this.selectLayer.set("value",a),this._createFeatureLayer(a),this.selectLayer.on("change",d.hitch(this,function(a){this._createFeatureLayer(a)}))))},setConfig:function(a){this.config=a;this.showFeatureCount.set("checked",a.showFeatureCount);if(a.showFeatureCount){var b=
this.nls.count;a.featureCountLabel&&(b=a.featureCountLabel);this.featureCountLabel.set("value",b)}else this.featureCountLabel.set("readOnly",!0);this.displayCluster.set("checked",a.displayCluster);this.refreshInterval.set("value",a.refreshInterval)},_loadSummaryConfig:function(){this.config.summaryLayer&&(this.summaryFields=[],e.forEach(this.config.summaryLayer.fields,d.hitch(this,function(a){this.summaryFields.push({type:a.type,label:a.label,field:a.field})})))},_createFeatureLayer:function(a){e.some(this.map.itemInfo.itemData.operationalLayers,
d.hitch(this,function(b){if("ArcGISFeatureLayer"===b.layerType)if(b.featureCollection)for(var c=0;c<b.featureCollection.layers.length;c++){var d=b.featureCollection.layers[c].layerObject;if(d.id===a)return this.summaryLayer=d,!0}else if(b.layerObject&&b.id===a)return this.summaryLayer=b.layerObject,!0}));this._populateSummaryTable(this.summaryLayer)},_populateSummaryTable:function(a){var b=a.fields;this.filterFields=[];this.filterFields.push({label:"-",value:""});this.layerFields=[];e.forEach(b,d.hitch(this,
function(b){b.name!==a.objectIdField&&(this.filterFields.push({label:b.alias,value:b.name}),"esriFieldTypeInteger"!==b.type&&"esriFieldTypeDouble"!==b.type&&"esriFieldTypeSmallInteger"!==b.type||this.layerFields.push({label:b.alias,value:b.name}))}));this._createFilter();this._loadSummaryConfig();this._setSummaryTable()},_setSummaryTable:function(){this.summaryTable.clear();this.config.summaryLayer&&this.config.summaryLayer.url===this.selectLayer.value&&e.forEach(this.config.summaryLayer.fields,d.hitch(this,
function(a){this._populateSummaryTableRow(a)}))},_populateSummaryTableRow:function(a){var b=this.summaryTable.addRow({});b.success&&b.tr&&(b=b.tr,this._addSummaryTypes(b),this._addSummaryFields(b),this._addSummaryLabel(b),b.selectTypes.set("value",a.type),b.selectFields.set("value",a.field),b.labelText.set("value",a.label))},_setSelectedIndex:function(a,b){e.forEach(a.options,function(c,d){c.value===b&&a.set("selectedIndex",d)})},_createFilter:function(){var a=d.clone(this.filterFields);this.filterSelect.set("options",
a);null!==this.config.summaryLayer&&this.filterSelect.set("value",this.config.summaryLayer.filterField)},_addSummaryFieldRow:function(){var a=this.summaryTable.addRow({});a.success&&a.tr&&(a=a.tr,this._addSummaryTypes(a),this._addSummaryFields(a),this._addSummaryLabel(a))},_addSummaryTypes:function(a){var b=d.clone(this.summaryTypes),c=k(".simple-table-cell",a)[0];c&&(g.setStyle(c,"verticalAlign","middle"),b=new l({style:{width:"100%",height:"30px"},options:b}),b.placeAt(c),b.startup(),a.selectTypes=
b)},_addSummaryFields:function(a){var b=d.clone(this.layerFields),c=k(".simple-table-cell",a)[1];g.setStyle(c,"verticalAlign","middle");b=new l({style:{width:"100%",height:"30px"},options:b});b.placeAt(c);b.startup();a.selectFields=b},_addSummaryLabel:function(a){var b=k(".simple-table-cell",a)[2];g.setStyle(b,"verticalAlign","middle");var c=new q({style:{width:"100%",height:"30px"}});c.placeAt(b);c.startup();a.labelText=c},getConfig:function(){this.config.showFeatureCount=this.showFeatureCount.checked;
this.config.featureCountLabel=this.featureCountLabel.value;this.config.displayCluster=this.displayCluster.checked;this.config.refreshInterval=this.refreshInterval.value;var a={},b=this.summaryTable.getRows(),c=[];e.forEach(b,d.hitch(this,function(a){c.push({type:a.selectTypes.value,label:a.labelText.value,field:a.selectFields.value})}));d.mixin(a,{fields:c});this.selectLayer&&e.forEach(this.selectLayer.options,d.hitch(this,function(b){b.selected&&d.mixin(a,{id:b.value,name:b.label,filterField:this.filterSelect.valueNode.value,
url:b.value})}));this.config.summaryLayer=a;return this.config}})});;;;;
